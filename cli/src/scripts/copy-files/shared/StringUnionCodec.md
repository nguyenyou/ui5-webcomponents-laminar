...
/** 
 * A utility for creating codecs for string union types.
 * This can be used with literal union types like "A" | "B" | "C" to create proper codecs.
 */
object StringUnionCodec {
  /** 
   * Creates a codec for a string union type.
   * 
   * @tparam T The string union type (e.g., "A" | "B" | "C")
   * @return A codec that can encode/decode between T and String
   */
