...
object distMultiComboBoxItemMod {
  ...
  inline def isInstanceOfMultiComboBoxItem(`object`: Any): /* is @ui5/webcomponents.@ui5/webcomponents/dist/MultiComboBoxItem.MultiComboBoxItem */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstanceOfMultiComboBoxItem")(`object`.asInstanceOf[js.Any]).asInstanceOf[/* is @ui5/webcomponents.@ui5/webcomponents/dist/MultiComboBoxItem.MultiComboBoxItem */ Boolean]
  ...
  trait MultiComboBoxItem
    extends io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distComboBoxItemMod.default {
    ...
    def isMultiComboBoxItem: Boolean = js.native
  }
}
