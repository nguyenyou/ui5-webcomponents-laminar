...
object distDynamicDateRangeOptionsLastOptionsMod {
  ...
  /**
    ...
    * @since 2.14.0
    */
  @JSImport("@ui5/webcomponents/dist/dynamic-date-range-options/LastOptions.js", JSImport.Default)
  @js.native
  open class default ()
    extends StObject
       with LastOptions {
  ...
  trait LastOptions
    ...
    def handleSelectionChange_MLastOptions(e: CustomEvent): js.UndefOr[DynamicDateRangeValue] = js.native
    
    var i18nKey: I18nText = js.native
    
    @JSName("icon")
    def icon_MLastOptions: String = js.native
    
    @JSName("operator")
    def operator_MLastOptions: String = js.native
    
    var options: js.UndefOr[js.Array[String]] = js.native
    
    @JSName("template")
    def template_MLastOptions(): JsxTemplateResult = js.native
    @JSName("template")
    var template_Original: JsxTemplate = js.native
    
    @JSName("text")
    def text_MLastOptions: String = js.native
  }
}
