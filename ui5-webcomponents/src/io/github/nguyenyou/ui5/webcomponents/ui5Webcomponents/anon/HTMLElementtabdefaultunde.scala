...
/* Inlined std.HTMLElement & {  tab :@ui5/webcomponents-base.@ui5/webcomponents-base/dist/UI5Element.default | undefined} */
@js.native
trait HTMLElementtabdefaultunde extends StObject {
  ...
  var tab: js.UndefOr[default] = js.native
