...
object distTableRowBaseMod {
  ...
  /**
    ...
    * @public
    */
  /* note: abstract class */ @JSImport("@ui5/webcomponents/dist/TableRowBase", JSImport.Default)
  @js.native
  open class default () extends TableRowBase
  object default {
    
    @JSImport("@ui5/webcomponents/dist/TableRowBase", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    /* static member */
    @JSImport("@ui5/webcomponents/dist/TableRowBase", "default.i18nBundle")
    @js.native
