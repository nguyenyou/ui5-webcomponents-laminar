...
object distMenuSeparatorMod {
  ...
  @JSImport("@ui5/webcomponents/dist/MenuSeparator.js", JSImport.Namespace)
  @js.native
  ...
  inline def isInstanceOfMenuSeparator(`object`: Any): /* is @ui5/webcomponents.@ui5/webcomponents/dist/MenuSeparator.MenuSeparator */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstanceOfMenuSeparator")(`object`.asInstanceOf[js.Any]).asInstanceOf[/* is @ui5/webcomponents.@ui5/webcomponents/dist/MenuSeparator.MenuSeparator */ Boolean]
  ...
  trait MenuSeparator
    ...
    @JSName("isSeparator")
    var isSeparator_FMenuSeparator: js.UndefOr[Boolean] = js.native
  }
}
