...
trait PartialListItemHooks extends StObject {
  ...
  var iconBegin: js.UndefOr[JsxTemplate] = js.undefined
  
  var iconEnd: js.UndefOr[JsxTemplate] = js.undefined
  
  var imageBegin: js.UndefOr[JsxTemplate] = js.undefined
  
  var listItemContent: js.UndefOr[JsxTemplate] = js.undefined
  
  var listItemPreContent: js.UndefOr[JsxTemplate] = js.undefined
  
  var selectionElement: js.UndefOr[JsxTemplate] = js.undefined
}
