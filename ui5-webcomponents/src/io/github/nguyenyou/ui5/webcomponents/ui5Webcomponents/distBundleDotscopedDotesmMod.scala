...
object distBundleDotscopedDotesmMod {
  ...
  object default {
    ...
    @JSImport("@ui5/webcomponents/dist/bundle.scoped.esm", JSImport.Default)
    @js.native
    val ^ : js.Any = js.native
    
    /* This class was inferred from a value with a constructor. In rare cases (like HTMLElement in the DOM) it might not work as you expect. */
    @JSImport("@ui5/webcomponents/dist/bundle.scoped.esm", "default.ResizeHandler")
    @js.native
    ...
    @JSImport("@ui5/webcomponents/dist/bundle.scoped.esm", "default.configuration")
    @js.native
    ...
    @JSImport("@ui5/webcomponents/dist/bundle.scoped.esm", "default.defaultTexts")
    @js.native
    ...
    @JSImport("@ui5/webcomponents/dist/bundle.scoped.esm", "default.generateHighlightedMarkup")
    @js.native
    ...
    @JSImport("@ui5/webcomponents/dist/bundle.scoped.esm", "default.invisibleMessage")
    @js.native
