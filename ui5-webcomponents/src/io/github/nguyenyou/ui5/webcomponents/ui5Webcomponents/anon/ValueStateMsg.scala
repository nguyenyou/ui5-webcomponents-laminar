...
trait ValueStateMsg extends StObject {
  ...
  var root: Ui5textarearoot
  
  var valueStateMsg: Ui5valuestatemessageheader
}
object ValueStateMsg {
  
  inline def apply(root: Ui5textarearoot, valueStateMsg: Ui5valuestatemessageheader): ValueStateMsg = {
  ...
  implicit open class MutableBuilder[Self <: ValueStateMsg] (val x: Self) extends AnyVal {
    ...
    inline def setRoot(value: Ui5textarearoot): Self = StObject.set(x, "root", value.asInstanceOf[js.Any])
