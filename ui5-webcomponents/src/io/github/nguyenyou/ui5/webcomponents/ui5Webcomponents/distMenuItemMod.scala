...
object distMenuItemMod {
  ...
  object default {
    ...
    /* static member */
    @JSImport("@ui5/webcomponents/dist/MenuItem", "default.i18nBundle")
    @js.native
  ...
  trait MenuItem
    ...
    def _navigateToEndContent(): Unit = js.native
    def _navigateToEndContent(isLast: Boolean): Unit = js.native
