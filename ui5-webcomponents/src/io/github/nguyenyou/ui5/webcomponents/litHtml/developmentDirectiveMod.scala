...
import io.github.nguyenyou.ui5.webcomponents.litHtml.developmentLitHtmlMod.Disconnectable
import io.github.nguyenyou.ui5.webcomponents.litHtml.developmentLitHtmlMod.Part
...
import io.github.nguyenyou.ui5.webcomponents.litHtml.litHtmlInts.`3`
import io.github.nguyenyou.ui5.webcomponents.litHtml.litHtmlInts.`4`
import io.github.nguyenyou.ui5.webcomponents.litHtml.litHtmlInts.`5`
import io.github.nguyenyou.ui5.webcomponents.litHtml.litHtmlInts.`6`
...
object developmentDirectiveMod {
  ...
  /* Rewritten from type alias, can be one of: 
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.litHtmlInts.`3`
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.litHtmlInts.`2`
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.litHtmlInts.`4`
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.litHtmlInts.`5`
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.litHtmlInts.`6`
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.litHtmlInts.`1`
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.developmentDirectiveMod.ChildPartInfo
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.developmentDirectiveMod.AttributePartInfo
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.developmentDirectiveMod.ElementPartInfo
  */
  trait PartInfo extends StObject
  object PartInfo {
    
    inline def AttributePartInfo(name: String, tagName: String, `type`: `1` | `3` | `4` | `5`): io.github.nguyenyou.ui5.webcomponents.litHtml.developmentDirectiveMod.AttributePartInfo = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], tagName = tagName.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[io.github.nguyenyou.ui5.webcomponents.litHtml.developmentDirectiveMod.AttributePartInfo]
    }
    
    inline def ChildPartInfo(): io.github.nguyenyou.ui5.webcomponents.litHtml.developmentDirectiveMod.ChildPartInfo = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(2)
      __obj.asInstanceOf[io.github.nguyenyou.ui5.webcomponents.litHtml.developmentDirectiveMod.ChildPartInfo]
    }
    
    inline def ElementPartInfo(): io.github.nguyenyou.ui5.webcomponents.litHtml.developmentDirectiveMod.ElementPartInfo = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(6)
      __obj.asInstanceOf[io.github.nguyenyou.ui5.webcomponents.litHtml.developmentDirectiveMod.ElementPartInfo]
    }
  }
}
