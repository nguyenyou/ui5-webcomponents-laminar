...
import io.github.nguyenyou.ui5.webcomponents.litHtml.mod.Disconnectable
import io.github.nguyenyou.ui5.webcomponents.litHtml.mod.Part
import io.github.nguyenyou.ui5.webcomponents.std.Parameters
...
object directiveMod {
  ...
  */
  ...
  /* Rewritten from type alias, can be one of: 
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.directiveMod.ChildPartInfo
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.directiveMod.AttributePartInfo
    - `io.github.nguyenyou.ui5.webcomponents`.litHtml.directiveMod.ElementPartInfo
  */
  trait PartInfo extends StObject
  object PartInfo {
    
    inline def AttributePartInfo(name: String, tagName: String, `type`: `1` | `3` | `4` | `5`): io.github.nguyenyou.ui5.webcomponents.litHtml.directiveMod.AttributePartInfo = {
      val __obj = js.Dynamic.literal(name = name.asInstanceOf[js.Any], tagName = tagName.asInstanceOf[js.Any])
      __obj.updateDynamic("type")(`type`.asInstanceOf[js.Any])
      __obj.asInstanceOf[io.github.nguyenyou.ui5.webcomponents.litHtml.directiveMod.AttributePartInfo]
    }
    
    inline def ChildPartInfo(): io.github.nguyenyou.ui5.webcomponents.litHtml.directiveMod.ChildPartInfo = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(2)
      __obj.asInstanceOf[io.github.nguyenyou.ui5.webcomponents.litHtml.directiveMod.ChildPartInfo]
    }
    
    inline def ElementPartInfo(): io.github.nguyenyou.ui5.webcomponents.litHtml.directiveMod.ElementPartInfo = {
      val __obj = js.Dynamic.literal()
      __obj.updateDynamic("type")(6)
      __obj.asInstanceOf[io.github.nguyenyou.ui5.webcomponents.litHtml.directiveMod.ElementPartInfo]
    }
  }
}
