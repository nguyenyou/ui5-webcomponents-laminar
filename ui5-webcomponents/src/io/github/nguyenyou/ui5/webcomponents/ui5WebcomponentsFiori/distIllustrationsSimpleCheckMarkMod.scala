...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.SimpleCheckMark
...
object distIllustrationsSimpleCheckMarkMod extends Shortcut {
  ...
  type _To = SimpleCheckMark
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsSimpleCheckMarkMod.foo` */
  override def _to: SimpleCheckMark = default
}
