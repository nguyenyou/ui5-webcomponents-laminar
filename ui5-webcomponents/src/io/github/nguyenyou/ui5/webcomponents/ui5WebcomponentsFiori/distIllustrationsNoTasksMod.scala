...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.NoTasks
...
object distIllustrationsNoTasksMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsNoTasksMod.foo` */
  override def _to: NoTasks = default
}
