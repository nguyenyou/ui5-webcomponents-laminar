...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.SimpleReload
...
object distIllustrationsSimpleReloadMod extends Shortcut {
  ...
  type _To = SimpleReload
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsSimpleReloadMod.foo` */
  override def _to: SimpleReload = default
}
