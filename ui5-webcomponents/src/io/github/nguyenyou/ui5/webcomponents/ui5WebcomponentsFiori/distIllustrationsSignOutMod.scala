...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.SignOut
...
object distIllustrationsSignOutMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsSignOutMod.foo` */
  override def _to: SignOut = default
}
