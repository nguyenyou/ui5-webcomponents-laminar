...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.PageNotFound
...
object distIllustrationsPageNotFoundMod extends Shortcut {
  ...
  type _To = PageNotFound
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsPageNotFoundMod.foo` */
  override def _to: PageNotFound = default
}
