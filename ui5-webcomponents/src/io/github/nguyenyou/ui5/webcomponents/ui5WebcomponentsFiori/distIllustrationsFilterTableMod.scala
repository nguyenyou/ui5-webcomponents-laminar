...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.FilterTable
...
object distIllustrationsFilterTableMod extends Shortcut {
  ...
  type _To = FilterTable
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsFilterTableMod.foo` */
  override def _to: FilterTable = default
}
