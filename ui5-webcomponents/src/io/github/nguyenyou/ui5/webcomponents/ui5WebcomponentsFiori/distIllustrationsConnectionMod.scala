...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.Connection
...
object distIllustrationsConnectionMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsConnectionMod.foo` */
  override def _to: Connection = default
}
