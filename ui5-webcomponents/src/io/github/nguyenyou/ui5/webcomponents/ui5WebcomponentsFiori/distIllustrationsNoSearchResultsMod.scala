...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.NoSearchResults
...
object distIllustrationsNoSearchResultsMod extends Shortcut {
  ...
  type _To = NoSearchResults
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsNoSearchResultsMod.foo` */
  override def _to: NoSearchResults = default
}
