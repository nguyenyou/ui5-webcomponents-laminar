...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.EmptyCalendar
...
object distIllustrationsEmptyCalendarMod extends Shortcut {
  ...
  type _To = EmptyCalendar
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsEmptyCalendarMod.foo` */
  override def _to: EmptyCalendar = default
}
