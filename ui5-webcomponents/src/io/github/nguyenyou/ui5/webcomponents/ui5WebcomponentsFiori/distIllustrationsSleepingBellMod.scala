...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.SleepingBell
...
object distIllustrationsSleepingBellMod extends Shortcut {
  ...
  type _To = SleepingBell
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsSleepingBellMod.foo` */
  override def _to: SleepingBell = default
}
