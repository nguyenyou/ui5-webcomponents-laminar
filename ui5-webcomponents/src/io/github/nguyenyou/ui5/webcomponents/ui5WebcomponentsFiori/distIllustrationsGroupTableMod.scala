...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.GroupTable
...
object distIllustrationsGroupTableMod extends Shortcut {
  ...
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsGroupTableMod.foo` */
  override def _to: GroupTable = default
}
