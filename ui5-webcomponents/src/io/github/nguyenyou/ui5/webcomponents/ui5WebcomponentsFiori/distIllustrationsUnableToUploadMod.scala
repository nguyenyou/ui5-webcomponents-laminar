...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.UnableToUpload
...
object distIllustrationsUnableToUploadMod extends Shortcut {
  ...
  type _To = UnableToUpload
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsUnableToUploadMod.foo` */
  override def _to: UnableToUpload = default
}
