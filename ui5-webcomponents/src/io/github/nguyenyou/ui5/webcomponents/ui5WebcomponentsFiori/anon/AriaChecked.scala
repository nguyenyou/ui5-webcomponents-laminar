...
trait AriaChecked extends StObject {
  ...
  var ariaHaspopup: js.UndefOr[
    /* template literal string: ${import(@ui5/webcomponents-base/dist/types.js).AriaHasPopup} */ String
  ] = js.undefined
...
object AriaChecked {
  ...
  inline def apply(ariaLabel: String, ariaLabelRadioButton: String, role: AriaRole): AriaChecked = {
  ...
  implicit open class MutableBuilder[Self <: AriaChecked] (val x: Self) extends AnyVal {
    ...
    inline def setAriaHaspopup(
      value: /* template literal string: ${import(@ui5/webcomponents-base/dist/types.js).AriaHasPopup} */ String
