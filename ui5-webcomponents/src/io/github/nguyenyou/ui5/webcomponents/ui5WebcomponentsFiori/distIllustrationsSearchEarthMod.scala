...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.SearchEarth
...
object distIllustrationsSearchEarthMod extends Shortcut {
  ...
  type _To = SearchEarth
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsSearchEarthMod.foo` */
  override def _to: SearchEarth = default
}
