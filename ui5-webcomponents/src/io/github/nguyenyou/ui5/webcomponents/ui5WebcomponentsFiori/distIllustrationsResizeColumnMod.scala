...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.ResizeColumn
...
object distIllustrationsResizeColumnMod extends Shortcut {
  ...
  type _To = ResizeColumn
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsResizeColumnMod.foo` */
  override def _to: ResizeColumn = default
}
