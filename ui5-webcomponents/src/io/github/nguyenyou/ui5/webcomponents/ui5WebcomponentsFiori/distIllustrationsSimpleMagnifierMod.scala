...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.ui5WebcomponentsFioriStrings.SimpleMagnifier
...
object distIllustrationsSimpleMagnifierMod extends Shortcut {
  ...
  type _To = SimpleMagnifier
  
  /* This means you don't have to write `default`, but can instead just say `distIllustrationsSimpleMagnifierMod.foo` */
  override def _to: SimpleMagnifier = default
}
