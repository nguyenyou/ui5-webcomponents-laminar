...
object distUserMenuItemGroupMod {
  
  @JSImport("@ui5/webcomponents-fiori/dist/UserMenuItemGroup.js", JSImport.Namespace)
  @js.native
  ...
  @js.native
  open class default ()
    extends io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distMenuItemGroupMod.default
  
  inline def isInstanceOfUserMenuItemGroup(`object`: Any): /* is @ui5/webcomponents-fiori.@ui5/webcomponents-fiori/dist/UserMenuItemGroup.UserMenuItemGroup */ Boolean = ^.asInstanceOf[js.Dynamic].applyDynamic("isInstanceOfUserMenuItemGroup")(`object`.asInstanceOf[js.Any]).asInstanceOf[/* is @ui5/webcomponents-fiori.@ui5/webcomponents-fiori/dist/UserMenuItemGroup.UserMenuItemGroup */ Boolean]
  ...
  /**
    ...
    * @public
    */
  type UserMenuItemGroup = io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distMenuItemGroupMod.default
}
