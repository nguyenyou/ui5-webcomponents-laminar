...
trait VideoHTMLAttributes[T /* <: EventTarget */]
  extends StObject
     with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.MediaHTMLAttributes[T] {
...
object VideoHTMLAttributes {
  ...
  inline def apply[T /* <: EventTarget */](): VideoHTMLAttributes[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[VideoHTMLAttributes[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: VideoHTMLAttributes[?], T /* <: EventTarget */] (val x: Self & VideoHTMLAttributes[T]) extends AnyVal {
