...
/* Inlined std.Omit<@ui5/webcomponents-base.@ui5/webcomponents-base/dist/thirdparty/preact/jsx.JSXInternal.MTableMathMLAttributes<std.MathMLElement>, 'class'> & {  class :object | string | undefined} */
trait OmitMTableMathMLAttribute extends StObject {
...
object OmitMTableMathMLAttribute {
  
  inline def apply(): OmitMTableMathMLAttribute = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[OmitMTableMathMLAttribute]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: OmitMTableMathMLAttribute] (val x: Self) extends AnyVal {
