...
/* Inlined @ui5/webcomponents-base.@ui5/webcomponents-base/dist/thirdparty/preact/jsx.JSXInternal.TargetedEvent<Target, std.SubmitEvent> */
trait TargetedSubmitEvent[Target /* <: EventTarget */] extends StObject {
...
object TargetedSubmitEvent {
  ...
  inline def apply[Target /* <: EventTarget */](
    ...
    __obj.asInstanceOf[TargetedSubmitEvent[Target]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TargetedSubmitEvent[?], Target /* <: EventTarget */] (val x: Self & TargetedSubmitEvent[Target]) extends AnyVal {
