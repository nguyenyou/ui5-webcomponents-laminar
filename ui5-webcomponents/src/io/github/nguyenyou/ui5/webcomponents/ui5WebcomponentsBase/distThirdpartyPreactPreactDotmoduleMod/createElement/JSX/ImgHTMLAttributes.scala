...
trait ImgHTMLAttributes[T /* <: EventTarget */]
  ...
  var decoding: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[async | auto | sync]]
  ] = js.undefined
...
object ImgHTMLAttributes {
  ...
  implicit open class MutableBuilder[Self <: ImgHTMLAttributes[?], T /* <: EventTarget */] (val x: Self & ImgHTMLAttributes[T]) extends AnyVal {
    ...
    inline def setDecoding(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[async | auto | sync]]
