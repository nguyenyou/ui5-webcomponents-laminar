...
open class Component[P, S] () extends StObject {
  ...
  def render(): ComponentChildren = js.native
  def render(props: RenderableProps[P, Any]): ComponentChildren = js.native
  def render(props: RenderableProps[P, Any], state: S): ComponentChildren = js.native
  def render(props: RenderableProps[P, Any], state: S, context: Any): ComponentChildren = js.native
  def render(props: RenderableProps[P, Any], state: Unit, context: Any): ComponentChildren = js.native
  def render(props: Unit, state: S): ComponentChildren = js.native
  def render(props: Unit, state: S, context: Any): ComponentChildren = js.native
  def render(props: Unit, state: Unit, context: Any): ComponentChildren = js.native
