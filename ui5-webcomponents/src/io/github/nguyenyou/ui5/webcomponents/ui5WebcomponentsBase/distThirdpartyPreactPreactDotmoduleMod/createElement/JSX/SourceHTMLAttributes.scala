...
trait SourceHTMLAttributes[T /* <: EventTarget */]
  extends StObject
...
object SourceHTMLAttributes {
  ...
  inline def apply[T /* <: EventTarget */](): SourceHTMLAttributes[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[SourceHTMLAttributes[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: SourceHTMLAttributes[?], T /* <: EventTarget */] (val x: Self & SourceHTMLAttributes[T]) extends AnyVal {
