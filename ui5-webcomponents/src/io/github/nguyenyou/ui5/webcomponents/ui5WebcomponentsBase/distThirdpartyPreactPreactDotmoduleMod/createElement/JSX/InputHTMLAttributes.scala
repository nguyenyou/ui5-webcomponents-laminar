...
trait InputHTMLAttributes[T /* <: EventTarget */]
  extends StObject
  ...
  var capture: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[user | environment]]
  ] = js.undefined
  ...
  var `type`: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.HTMLInputTypeAttribute
  ] = js.undefined
...
object InputHTMLAttributes {
  ...
  inline def apply[T /* <: EventTarget */](): InputHTMLAttributes[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[InputHTMLAttributes[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: InputHTMLAttributes[?], T /* <: EventTarget */] (val x: Self & InputHTMLAttributes[T]) extends AnyVal {
    ...
    inline def setCapture(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[user | environment]]
    ...
    inline def setType(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.HTMLInputTypeAttribute
