...
trait AreaHTMLAttributes[T /* <: EventTarget */]
  extends StObject
...
object AreaHTMLAttributes {
  ...
  inline def apply[T /* <: EventTarget */](): AreaHTMLAttributes[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[AreaHTMLAttributes[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: AreaHTMLAttributes[?], T /* <: EventTarget */] (val x: Self & AreaHTMLAttributes[T]) extends AnyVal {
