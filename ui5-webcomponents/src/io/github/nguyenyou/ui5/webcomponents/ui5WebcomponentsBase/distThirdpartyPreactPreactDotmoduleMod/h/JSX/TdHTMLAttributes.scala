...
trait TdHTMLAttributes[T /* <: EventTarget */]
  extends StObject
  ...
  var align: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[left | center | right | justify | char]]
  ] = js.undefined
  ...
  var valign: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[top | middle | bottom | baseline]]
  ] = js.undefined
...
object TdHTMLAttributes {
  ...
  inline def apply[T /* <: EventTarget */](): TdHTMLAttributes[T] = {
    val __obj = js.Dynamic.literal()
    __obj.asInstanceOf[TdHTMLAttributes[T]]
  }
  
  @scala.inline
  implicit open class MutableBuilder[Self <: TdHTMLAttributes[?], T /* <: EventTarget */] (val x: Self & TdHTMLAttributes[T]) extends AnyVal {
    ...
    inline def setAlign(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[left | center | right | justify | char]]
    ...
    inline def setValign(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[top | middle | bottom | baseline]]
