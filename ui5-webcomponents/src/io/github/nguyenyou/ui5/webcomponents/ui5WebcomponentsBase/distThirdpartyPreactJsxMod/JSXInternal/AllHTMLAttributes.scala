...
trait AllHTMLAttributes[RefType /* <: EventTarget */]
  ...
  var `class`: js.UndefOr[Signalish[js.UndefOr[String]]] = js.undefined
...
object AllHTMLAttributes {
  ...
  implicit open class MutableBuilder[Self <: AllHTMLAttributes[?], RefType /* <: EventTarget */] (val x: Self & AllHTMLAttributes[RefType]) extends AnyVal {
    ...
    inline def setClass(value: Signalish[js.UndefOr[String]]): Self = StObject.set(x, "class", value.asInstanceOf[js.Any])
