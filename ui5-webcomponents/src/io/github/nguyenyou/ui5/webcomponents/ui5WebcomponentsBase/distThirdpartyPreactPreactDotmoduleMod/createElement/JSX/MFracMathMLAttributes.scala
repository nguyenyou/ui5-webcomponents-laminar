...
object MFracMathMLAttributes {
  ...
  implicit open class MutableBuilder[Self <: MFracMathMLAttributes[?], T /* <: EventTarget */] (val x: Self & MFracMathMLAttributes[T]) extends AnyVal {
    ...
    ): Self = StObject.set(x, "denomalign", value.asInstanceOf[js.Any])
    
    inline def setDenomalignUndefined: Self = StObject.set(x, "denomalign", js.undefined)
    
    inline def setLinethickness(
    ...
    ): Self = StObject.set(x, "linethickness", value.asInstanceOf[js.Any])
    
    inline def setLinethicknessUndefined: Self = StObject.set(x, "linethickness", js.undefined)
    
    inline def setNumalign(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[center | left | right]]
    ): Self = StObject.set(x, "numalign", value.asInstanceOf[js.Any])
