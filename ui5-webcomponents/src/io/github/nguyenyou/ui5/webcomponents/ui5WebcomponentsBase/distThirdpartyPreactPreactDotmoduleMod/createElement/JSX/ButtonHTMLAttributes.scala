...
trait ButtonHTMLAttributes[T /* <: EventTarget */]
  ...
  var `type`: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[submit | reset | button]]
  ] = js.undefined
...
object ButtonHTMLAttributes {
  ...
  implicit open class MutableBuilder[Self <: ButtonHTMLAttributes[?], T /* <: EventTarget */] (val x: Self & ButtonHTMLAttributes[T]) extends AnyVal {
    ...
    inline def setType(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[submit | reset | button]]
