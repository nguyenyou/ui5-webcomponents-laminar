...
trait MTableMathMLAttributes[T /* <: EventTarget */]
  ...
  var columnlines: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[dashed | none | solid]]
  ] = js.undefined
...
object MTableMathMLAttributes {
  ...
  implicit open class MutableBuilder[Self <: MTableMathMLAttributes[?], T /* <: EventTarget */] (val x: Self & MTableMathMLAttributes[T]) extends AnyVal {
    ...
    inline def setColumnlines(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[dashed | none | solid]]
    ): Self = StObject.set(x, "columnlines", value.asInstanceOf[js.Any])
    
    inline def setColumnlinesUndefined: Self = StObject.set(x, "columnlines", js.undefined)
    
    inline def setColumnspacing(
    ...
    ): Self = StObject.set(x, "columnspacing", value.asInstanceOf[js.Any])
    ...
    inline def setFramespacing(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[String]]
    ): Self = StObject.set(x, "framespacing", value.asInstanceOf[js.Any])
    ...
    inline def setRowlines(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[dashed | none | solid]]
    ): Self = StObject.set(x, "rowlines", value.asInstanceOf[js.Any])
    
    inline def setRowlinesUndefined: Self = StObject.set(x, "rowlines", js.undefined)
    
    inline def setRowspacing(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[String]]
    ): Self = StObject.set(x, "rowspacing", value.asInstanceOf[js.Any])
