...
object MStyleMathMLAttributes {
  ...
  implicit open class MutableBuilder[Self <: MStyleMathMLAttributes[?], T /* <: EventTarget */] (val x: Self & MStyleMathMLAttributes[T]) extends AnyVal {
    ...
    inline def setScriptminsize(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[String]]
    ): Self = StObject.set(x, "scriptminsize", value.asInstanceOf[js.Any])
    
    inline def setScriptminsizeUndefined: Self = StObject.set(x, "scriptminsize", js.undefined)
    
    inline def setScriptsizemultiplier(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[String]]
    ): Self = StObject.set(x, "scriptsizemultiplier", value.asInstanceOf[js.Any])
