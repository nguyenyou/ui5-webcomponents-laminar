...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.DPubAriaRole
...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.WAIAriaRole
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal._HTMLAttributeAnchorTarget
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal._HTMLInputTypeAttribute
...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distTypesMod.AriaLandmarkRole
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distTypesMod._AriaAutoComplete
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distTypesMod._AriaCurrent
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distUi5elementMod.GlobalHTMLAttributeNames
...
object ui5WebcomponentsBaseStrings {
  ...
  sealed trait _blank
    extends StObject
       ...
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.h.JSX._HTMLAttributeAnchorTarget
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.createElement.JSX._HTMLAttributeAnchorTarget
  ...
  sealed trait _empty
    extends StObject
       ...
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.h.JSX.HTMLAttributeReferrerPolicy
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.createElement.JSX.HTMLAttributeReferrerPolicy
  ...
  @js.native
  sealed trait accesskey_
    extends StObject
       with GlobalHTMLAttributeNames
  inline def accesskey_ : accesskey_ = "accesskey".asInstanceOf[accesskey_]
  ...
  sealed trait alert
    extends StObject
       with AriaRole
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.h.JSX.AriaRole
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.createElement.JSX.AriaRole
       with WAIAriaRole
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.h.JSX.WAIAriaRole
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.createElement.JSX.WAIAriaRole
  ...
  sealed trait anonymous
    extends StObject
       with HTMLAttributeCrossOrigin
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.h.JSX.HTMLAttributeCrossOrigin
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.createElement.JSX.HTMLAttributeCrossOrigin
  ...
  @js.native
  sealed trait assertive_ extends StObject
  inline def assertive_ : assertive_ = "assertive".asInstanceOf[assertive_]
  ...
  @js.native
  sealed trait `bold-fraktur` extends StObject
  inline def `bold-fraktur`: `bold-fraktur` = "bold-fraktur".asInstanceOf[`bold-fraktur`]
  
  @js.native
  sealed trait `bold-italic` extends StObject
  inline def `bold-italic`: `bold-italic` = "bold-italic".asInstanceOf[`bold-italic`]
  
  @js.native
  sealed trait `bold-sans-serif` extends StObject
  inline def `bold-sans-serif`: `bold-sans-serif` = "bold-sans-serif".asInstanceOf[`bold-sans-serif`]
  
  @js.native
  sealed trait `bold-script` extends StObject
  inline def `bold-script`: `bold-script` = "bold-script".asInstanceOf[`bold-script`]
  
  @js.native
  sealed trait both
    extends StObject
       with _AriaAutoComplete
  ...
  sealed trait button
    extends StObject
       ...
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.h.JSX._HTMLInputTypeAttribute
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.createElement.JSX._HTMLInputTypeAttribute
  ...
  sealed trait `doc-abstract`
    extends StObject
       ...
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.createElement.JSX.AriaRole
       with DPubAriaRole
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.h.JSX.DPubAriaRole
       with io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactPreactDotmoduleMod.createElement.JSX.DPubAriaRole
  ...
  @js.native
  sealed trait `double-struck` extends StObject
  inline def `double-struck`: `double-struck` = "double-struck".asInstanceOf[`double-struck`]
  ...
  @js.native
  sealed trait `event name not found in GraveaccenteventDetailsGraveaccent field` extends StObject
  inline def `event name not found in GraveaccenteventDetailsGraveaccent field`: `event name not found in GraveaccenteventDetailsGraveaccent field` = ("event name not found in `eventDetails` field").asInstanceOf[`event name not found in GraveaccenteventDetailsGraveaccent field`]
  ...
  @js.native
  sealed trait fraktur extends StObject
  ...
  @js.native
  sealed trait looped extends StObject
  inline def looped: looped = "looped".asInstanceOf[looped]
  ...
  @js.native
  sealed trait onToggle extends StObject
  inline def onToggle: onToggle = "onToggle".asInstanceOf[onToggle]
  ...
  @js.native
  sealed trait `plaintext-only` extends StObject
  inline def `plaintext-only`: `plaintext-only` = "plaintext-only".asInstanceOf[`plaintext-only`]
  ...
  @js.native
  sealed trait polite_ extends StObject
  inline def polite_ : polite_ = "polite".asInstanceOf[polite_]
  ...
  @js.native
  sealed trait `sans-serif-bold-italic` extends StObject
  inline def `sans-serif-bold-italic`: `sans-serif-bold-italic` = "sans-serif-bold-italic".asInstanceOf[`sans-serif-bold-italic`]
  
  @js.native
  sealed trait `sans-serif-italic` extends StObject
  inline def `sans-serif-italic`: `sans-serif-italic` = "sans-serif-italic".asInstanceOf[`sans-serif-italic`]
  
  @js.native
  sealed trait sap_horizon extends StObject
  inline def sap_horizon: sap_horizon = "sap_horizon".asInstanceOf[sap_horizon]
  ...
  @js.native
  sealed trait statusline extends StObject
  inline def statusline: statusline = "statusline".asInstanceOf[statusline]
  ...
  @js.native
  sealed trait stretched extends StObject
  ...
  @js.native
  sealed trait tabindex_
    extends StObject
       with GlobalHTMLAttributeNames
  inline def tabindex_ : tabindex_ = "tabindex".asInstanceOf[tabindex_]
  ...
  @js.native
  sealed trait tailed extends StObject
  inline def tailed: tailed = "tailed".asInstanceOf[tailed]
  ...
  @js.native
  sealed trait writingSuggestions extends StObject
  inline def writingSuggestions: writingSuggestions = "writingSuggestions".asInstanceOf[writingSuggestions]
