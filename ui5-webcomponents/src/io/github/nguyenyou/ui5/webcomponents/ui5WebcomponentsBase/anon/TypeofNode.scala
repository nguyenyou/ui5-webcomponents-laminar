...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`0x04`
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`0x08`
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`0x10`
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`0x20`
...
trait TypeofNode extends StObject {
  ...
  /* standard dom */
  val ATTRIBUTE_NODE: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`2`
  ...
  /** node is an element. */
  /* standard dom */
  val ELEMENT_NODE: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`1`
  ...
  /** node is a Text node. */
  /* standard dom */
  val TEXT_NODE: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`3`
}
object TypeofNode {
  ...
  implicit open class MutableBuilder[Self <: TypeofNode] (val x: Self) extends AnyVal {
    ...
    inline def setATTRIBUTE_NODE(value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`2`): Self = StObject.set(x, "ATTRIBUTE_NODE", value.asInstanceOf[js.Any])
    ...
    inline def setELEMENT_NODE(value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`1`): Self = StObject.set(x, "ELEMENT_NODE", value.asInstanceOf[js.Any])
    ...
    inline def setTEXT_NODE(value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.ui5WebcomponentsBaseInts.`3`): Self = StObject.set(x, "TEXT_NODE", value.asInstanceOf[js.Any])
  }
}
