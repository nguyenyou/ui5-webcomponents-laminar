...
trait MActionMathMLAttributes[T /* <: EventTarget */]
  ...
  var actiontype: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[statusline | toggle]]
  ] = js.undefined
...
object MActionMathMLAttributes {
  ...
  implicit open class MutableBuilder[Self <: MActionMathMLAttributes[?], T /* <: EventTarget */] (val x: Self & MActionMathMLAttributes[T]) extends AnyVal {
    ...
    inline def setActiontype(
      value: io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsBase.distThirdpartyPreactJsxMod.JSXInternal.Signalish[js.UndefOr[statusline | toggle]]
    ): Self = StObject.set(x, "actiontype", value.asInstanceOf[js.Any])
