...
import io.github.nguyenyou.ui5.webcomponents.std.Intl.NumberFormatOptions
...
/* n */ NumberDictionary[T] {
  ...
  @JSName("find")
  def find_S[S /* <: T */](
    predicate: js.Function3[/* value */ T, /* index */ Double, /* obj */ js.Array[T], /* is S */ Boolean]
  ...
  def toLocaleString(locales: String, options: NumberFormatOptions & DateTimeFormatOptions): String = js.native
  def toLocaleString(locales: js.Array[String]): String = js.native
  def toLocaleString(locales: js.Array[String], options: NumberFormatOptions & DateTimeFormatOptions): String = js.native
