...
Instantiable0[Number]
  ...
  /**
    ...
    */
  /* standard es2015.core */
  def isFinite(number: Any): Boolean = js.native
  ...
  /**
    ...
    */
  /* standard es2015.core */
  def isInteger(number: Any): Boolean = js.native
  ...
  /**
    ...
    */
  /* standard es2015.core */
  def isNaN(number: Any): Boolean = js.native
  ...
  /**
    ...
    */
  /* standard es2015.core */
  def isSafeInteger(number: Any): Boolean = js.native
