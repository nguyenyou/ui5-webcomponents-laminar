...
import io.github.nguyenyou.ui5.webcomponents.std.Intl.DateTimeFormatOptions
import io.github.nguyenyou.ui5.webcomponents.std.stdStrings.default
import io.github.nguyenyou.ui5.webcomponents.std.stdStrings.number
import io.github.nguyenyou.ui5.webcomponents.std.stdStrings.string
...
trait Date extends StObject {
  ...
  def toLocaleDateString(locales: Unit, options: DateTimeFormatOptions): String = js.native
  
  def toLocaleString(locales: String): String = js.native
  def toLocaleString(locales: String, options: DateTimeFormatOptions): String = js.native
  def toLocaleString(locales: js.Array[String]): String = js.native
  def toLocaleString(locales: js.Array[String], options: DateTimeFormatOptions): String = js.native
  def toLocaleString(locales: Unit, options: DateTimeFormatOptions): String = js.native
  
  /** Returns a time as a string value appropriate to the host environment's current locale. */
  /* standard es5 */
  def toLocaleTimeString(): String = js.native
  def toLocaleTimeString(locales: String): String = js.native
  def toLocaleTimeString(locales: String, options: DateTimeFormatOptions): String = js.native
  def toLocaleTimeString(locales: js.Array[String]): String = js.native
  def toLocaleTimeString(locales: js.Array[String], options: DateTimeFormatOptions): String = js.native
  def toLocaleTimeString(locales: Unit, options: DateTimeFormatOptions): String = js.native
  ...
  var toPrimitive: (js.Function1[default, String]) & (js.Function1[string, String]) & (js.Function1[number, Double]) & (js.Function1[/* hint */ String, String | Double]) = js.native
