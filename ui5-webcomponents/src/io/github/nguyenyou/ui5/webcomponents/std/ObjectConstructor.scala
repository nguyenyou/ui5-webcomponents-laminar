...
Instantiable0[js.Object]
  ...
  StringDictionary[js.UndefOr[U | Null | js.Object]] */, U /* <: String | js.BigInt | Double | Boolean | js.Symbol */](o: T): T = js.native
  ...
  /**
    ...
    */
  /* standard es5 */
  def getOwnPropertyNames(o: Any): js.Array[String] = js.native
