...
trait EffectTiming extends StObject {
  ...
  /* standard dom */
  var duration: js.UndefOr[Double | CSSNumericValue | String] = js.undefined
...
object EffectTiming {
  ...
  implicit open class MutableBuilder[Self <: EffectTiming] (val x: Self) extends AnyVal {
    ...
    inline def setDuration(value: Double | CSSNumericValue | String): Self = StObject.set(x, "duration", value.asInstanceOf[js.Any])
