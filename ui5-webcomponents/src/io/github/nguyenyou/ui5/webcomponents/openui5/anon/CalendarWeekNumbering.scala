...
import io.github.nguyenyou.ui5.webcomponents.openui5.int
...
trait CalendarWeekNumbering extends StObject {
  ...
  var calendarType: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.openui5.sapBaseI18nDateCalendarTypeMod.CalendarType | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof CalendarType * / any */ String)
  ] = js.undefined
  ...
  var calendarWeekNumbering: js.UndefOr[
    io.github.nguyenyou.ui5.webcomponents.openui5.sapBaseI18nDateCalendarWeekNumberingMod.CalendarWeekNumbering | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof CalendarWeekNumbering * / any */ String)
  ] = js.undefined
...
object CalendarWeekNumbering {
  ...
  implicit open class MutableBuilder[Self <: CalendarWeekNumbering] (val x: Self) extends AnyVal {
    ...
    inline def setCalendarType(
      value: io.github.nguyenyou.ui5.webcomponents.openui5.sapBaseI18nDateCalendarTypeMod.CalendarType | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof CalendarType * / any */ String)
    ...
    inline def setCalendarWeekNumbering(
      value: io.github.nguyenyou.ui5.webcomponents.openui5.sapBaseI18nDateCalendarWeekNumberingMod.CalendarWeekNumbering | (/* keyof / * import warning: ResolveTypeQueries.resolve Couldn't resolve typeof CalendarWeekNumbering * / any */ String)
