...
object WebsiteIcons {
  ...
  def scaleSvgPath(path: String, scaleFactor: Double = 32): String = {
    ...
    val scaledPath = numberRegex.replaceAllIn(
      path,
      m => {
