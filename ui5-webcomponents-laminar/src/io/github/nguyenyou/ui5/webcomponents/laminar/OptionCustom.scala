...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distOptionCustomMod.{
  OptionCustom as OptionCustomComponent
}
...
object OptionCustom extends WebComponent("ui5-option-custom") {
  ...
  /** Defines the text, displayed inside the `Select` input filed when the
    * option gets selected.
    *
    * Default: undefined
    */
  lazy val displayText: HtmlAttr[String] =
    htmlAttr("display-text", StringAsIsCodec)
