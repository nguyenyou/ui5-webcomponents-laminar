...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsAi.distPromptInputMod.{
...
object PromptInput extends WebComponent("ui5-ai-prompt-input") {
  ...
  /** Fired when the input operation has finished by pressing Enter or AI button
    * is clicked.
    *
    * **Note:** Available since
    * [v2.0.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v2.0.0) of
