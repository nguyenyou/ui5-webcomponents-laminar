...
object TimePicker extends WebComponent("ui5-time-picker") {
  ...
  /** Determines the format, displayed in the input field.
    *
    * Example: HH:mm:ss -> 11:42:35 hh:mm:ss a -> 2:23:15 PM mm:ss -> 12:04
  ...
  /** Fired when the input operation has finished by clicking the "OK" button or
    * when the text in the input field has changed and the focus leaves the
    * input field.
    *
    * | cancelable | bubbles |
    * |:----------:|:-------:|
  ...
  lazy val onChange: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[TimePickerChangeEventDetail]
  ...
  lazy val onInput: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[TimePickerInputEventDetail]
  ] = new EventProp("input")
  ...
  /** Defines the value state message that will be displayed as pop up under the
    ...
    * will be displayed.
    *
    * **Note:** The `valueStateMessage` would be displayed, when the
    * `TimePicker` is in `Information`, `Critical` or `Negative` value state.
    *
