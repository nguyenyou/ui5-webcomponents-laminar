...
object MultiInput extends WebComponent("ui5-multi-input") {
  ...
  * | ❌|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[InputSelectionChangeEventDetail]]  = new EventProp("selection-change")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onTokenDelete: EventProp[Ui5CustomEvent[Ref] & EventDetail[MultiInputTokenDeleteEventDetail]]  = new EventProp("token-delete")
  /**
