...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distListItemCustomMod.{
  ListItemCustom as ListItemCustomComponent
}
...
object ListItemCustom extends WebComponent("ui5-li-custom") {
  ...
  /** Defines the text alternative of the component.
    *
    * **Note**: If not provided a default text alternative will be set, if
    * present.
    *
    * Default: undefined
    */
