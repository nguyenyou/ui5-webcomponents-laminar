...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distButtonMod.{ButtonAccessibilityAttributes,ButtonClickEventDetail}
...
object Button extends WebComponent("ui5-button") {
   ...
   * Default: "Button"
   */
  lazy val accessibleRole: HtmlAttr[ButtonAccessibleRole] = htmlAttr("accessible-role", StringUnionCodec[ButtonAccessibleRole])
  /**
