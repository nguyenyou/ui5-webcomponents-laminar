...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distDialogMod.{
...
object Dialog extends WebComponent("ui5-dialog") {
  ...
  /** Determines whether the component is draggable. If this property is set to
    * true, the Dialog will be draggable by its header.
    *
    * **Note:** The component can be draggable only in desktop mode.
    *
    * **Note:** This property overrides the default HTML "draggable" attribute
    * native behavior. When "draggable" is set to true, the native browser
    * "draggable" behavior is prevented and only the Dialog custom logic
    * ("draggable by its header") works.
    *
    * Default: false
    */
  lazy val draggable: HtmlAttr[Boolean] =
    htmlAttr("draggable", BooleanAsAttrPresenceCodec)
  ...
  /** Configures the component to be resizable. If this property is set to true,
    * the Dialog will have a resize handle in its bottom right corner in LTR
    * languages. In RTL languages, the resize handle will be placed in the
    * bottom left corner.
    *
    * **Note:** The component can be resizable only in desktop mode.
    *
    * **Note:** Upon resizing, externally defined height and width styling will
    * be ignored.
    *
    * Default: false
    */
  lazy val resizable: HtmlAttr[Boolean] =
    htmlAttr("resizable", BooleanAsAttrPresenceCodec)

  /** Defines the state of the `Dialog`.
    *
    * **Note:** If `"Negative"` and `"Critical"` states is set, it will change
    * the accessibility role to "alertdialog", if the accessibleRole property is
    * set to `"Dialog"`.
    *
    * Default: "None"
    */
  ...
  /** Determines if the dialog will be stretched to full screen on mobile. On
    * desktop, the dialog will be stretched to approximately 90% of the
    * viewport.
    *
    * **Note:** For better usability of the component it is recommended to set
    * this property to "true" when the dialog is opened on phone.
    *
    * Default: false
    */
  lazy val stretch: HtmlAttr[Boolean] =
    htmlAttr("stretch", BooleanAsAttrPresenceCodec)
  ...
  /** Defines the footer HTML Element.
    *
    * **Note:** When a `Bar` is used in the footer, you should remove the
    * default dialog's paddings.
    *
  ...
  /** Defines the header HTML Element.
    *
    * **Note:** When a `Bar` is used in the header, you should remove the
    * default dialog's paddings.
    *
    * **Note:** If `header` slot is provided, the labelling of the dialog is a
    * responsibility of the application developer. `accessibleName` should be
    * used.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot)
