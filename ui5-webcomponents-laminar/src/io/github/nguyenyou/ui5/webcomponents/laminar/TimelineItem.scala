...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distTimelineItemMod.TimelineItem as TimelineItemComponent
...
object TimelineItem extends WebComponent("ui5-timeline-item") {
  ...
  type Ref = TimelineItemComponent & dom.HTMLElement
