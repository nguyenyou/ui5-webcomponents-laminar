...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distListMod.{ListItemClickEventDetail,ListItemCloseEventDetail,ListItemDeleteEventDetail,ListItemToggleEventDetail,ListMoveEventDetail,ListSelectionChangeEventDetail}
...
object UList extends WebComponent("ui5-list") {
   ...
   * Default: "List"
   */
  lazy val accessibleRole: HtmlAttr[ListAccessibleRole] = htmlAttr("accessible-role", StringUnionCodec[ListAccessibleRole])
  /**
  ...
  * | ✅|✅|
   */
  lazy val onItemClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ListItemClickEventDetail]]  = new EventProp("item-click")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onItemClose: EventProp[Ui5CustomEvent[Ref] & EventDetail[ListItemCloseEventDetail]]  = new EventProp("item-close")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onItemDelete: EventProp[Ui5CustomEvent[Ref] & EventDetail[ListItemDeleteEventDetail]]  = new EventProp("item-delete")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onItemToggle: EventProp[Ui5CustomEvent[Ref] & EventDetail[ListItemToggleEventDetail]]  = new EventProp("item-toggle")
  /**
  ...
  * | ✅|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[ListSelectionChangeEventDetail]]  = new EventProp("selection-change")
