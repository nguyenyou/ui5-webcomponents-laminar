...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distToolbarMod.{
...
object Toolbar extends WebComponent("ui5-toolbar") {
  ...
  /** Indicated the direction in which the Toolbar items will be aligned.
    ...
    * Default: "End"
    */
  lazy val alignContent: HtmlAttr[ToolbarAlign] =
    htmlAttr("align-content", StringUnionCodec[ToolbarAlign])
  ...
  /** Defines the toolbar design.
    ...
    * Default: "Solid"
    */
  lazy val design: HtmlAttr[ToolbarDesign] =
    htmlAttr("design", StringUnionCodec[ToolbarDesign])
