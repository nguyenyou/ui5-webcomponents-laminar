...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTableSelectionMultiMod.{
  TableSelectionMulti as TableSelectionMultiComponent
}
...
object TableSelectionMulti extends WebComponent("ui5-table-selection-multi") {
  ...
  type Ref = TableSelectionMultiComponent with dom.HTMLElement
