...
abstract class WebComponent(tagName: String) { this: Self =>
  ...
  /** Override this with JSImport-ed object of the component. The import must
    * register the component's custom element in the DOM.
    */
  ...
  /** Instantiate this component using the specified modifiers.
    ...
    */
  final def apply(
      componentMods: ComponentMod*
  )(laminarMods: LaminarMod*): Element = {
    val el = tag()
