...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distCalendarDateMod.{
  CalendarDate as CalendarDateComponent
}
...
object CalendarDate extends WebComponent("ui5-date") {
  ...
  type Ref = CalendarDateComponent with dom.HTMLElement
