...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distFilterItemMod.{
  FilterItem as FilterItemComponent
}
...
object FilterItem extends WebComponent("ui5-filter-item") {
  ...
  /** Defines the `values` list.
    ...
    * attribute (`slot="values"`). Since you can't change the DOM order of slots
