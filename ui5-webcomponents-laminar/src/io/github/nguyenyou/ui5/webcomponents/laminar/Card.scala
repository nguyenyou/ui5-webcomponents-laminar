...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distCardMod.{
...
object Card extends WebComponent("ui5-card") {
  ...
  /** Defines the accessible name of the component, which is used as the name of
    * the card region and should be unique per card.
    *
    * **Note:** `accessibleName` should be always set, unless
    * `accessibleNameRef` is set.
    *
    * Default: undefined
    */
