...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTableMod.{TableMoveEventDetail,TableRowActionClickEventDetail,TableRowClickEventDetail}
...
object Table extends WebComponent("ui5-table") {
  ...
  * | ❌|✅|
   */
  lazy val onRowActionClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[TableRowActionClickEventDetail]]  = new EventProp("row-action-click")
  /**
