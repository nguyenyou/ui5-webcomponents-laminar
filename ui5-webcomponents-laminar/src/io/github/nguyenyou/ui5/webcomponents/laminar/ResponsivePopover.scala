...
object ResponsivePopover extends WebComponent("ui5-responsive-popover") {
   ...
   * Default: "Dialog"
   */
  lazy val accessibleRole: HtmlAttr[PopupAccessibleRole] = htmlAttr("accessible-role", StringUnionCodec[PopupAccessibleRole])
  /**
   ...
   * Default: "Center"
   */
  lazy val verticalAlign: HtmlAttr[PopoverVerticalAlign] = htmlAttr("vertical-align", StringUnionCodec[PopoverVerticalAlign])
  ...
  * | ✅|❌|
   */
  lazy val onBeforeClose: EventProp[Ui5CustomEvent[Ref] & EventDetail[PopupBeforeCloseEventDetail]]  = new EventProp("before-close")
  /**
