...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTokenMod.{
...
object Token extends WebComponent("ui5-token") {
  ...
  /** Defines the close icon for the token. If nothing is provided to this slot,
    * the default close icon will be used. Accepts `Icon`.
    *
    ...
    * attribute (`slot="closeIcon"`). Since you can't change the DOM order of
