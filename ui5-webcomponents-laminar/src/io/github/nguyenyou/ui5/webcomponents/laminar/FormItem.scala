...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distFormItemMod.{
...
object FormItem extends WebComponent("ui5-form-item") {
  ...
  /** Defines the column span of the component, e.g how many columns the
    * component should span to.
    *
    * **Note:** The column span should be a number between 1 and the available
    * columns of the FormGroup (when items are placed in a group) or the Form.
    * The available columns can be affected by the FormGroup#columnSpan and/or
    * the Form#layout. A number bigger than the available columns won't take
    * effect.
    *
    * Default: undefined
    */
  ...
  /** Defines the label of the component.
    ...
    * attribute (`slot="labelContent"`). Since you can't change the DOM order of
