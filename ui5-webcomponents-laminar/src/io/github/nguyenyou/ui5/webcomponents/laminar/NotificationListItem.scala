...
object NotificationListItem extends WebComponent("ui5-li-notification") {
   ...
   * Default: "Standard"
   */
  lazy val importance: HtmlAttr[NotificationListItemImportance] = htmlAttr("importance", StringUnionCodec[NotificationListItemImportance])
  /**
  ...
  * | ❌|✅|
   */
  lazy val onClose: EventProp[Ui5CustomEvent[Ref] & EventDetail[NotificationListItemCloseEventDetail]]  = new EventProp("close")
