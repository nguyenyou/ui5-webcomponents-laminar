...
object MessageStrip extends WebComponent("ui5-message-strip") {
  ...
  /** Defines the color scheme of the component. There are 10 predefined
    * schemes. To use one you can set a number from `"1"` to `"10"`. The
    * `colorScheme` `"1"` will be set by default.
    *
    ...
    * Default: "1"
    */
  lazy val colorScheme: HtmlAttr[String] =
    htmlAttr("color-scheme", StringAsIsCodec)

  /** Defines the component type.
    *
    * Default: "Information"
    */
  lazy val design: HtmlAttr[MessageStripDesign] =
    htmlAttr("design", StringUnionCodec[MessageStripDesign])
  type MessageStripDesign = "Information" | "Positive" | "Negative" |
    "Critical" | "ColorSet1" | "ColorSet2"

  /** Defines whether the MessageStrip renders close button.
    *
    * Default: false
    */
  lazy val hideCloseButton: HtmlAttr[Boolean] =
    htmlAttr("hide-close-button", BooleanAsAttrPresenceCodec)

  /** Defines whether the MessageStrip will show an icon in the beginning. You
    * can directly provide an icon with the `icon` slot. Otherwise, the default
    * icon for the type will be used.
    *
    * * **Note:** If <code>MessageStripDesign.ColorSet1</code> or
    * <code>MessageStripDesign.ColorSet2</code> value is set to the
    * <code>design</code> property, default icon will not be presented.
    *
    * Default: false
    */
  lazy val hideIcon: HtmlAttr[Boolean] =
    htmlAttr("hide-icon", BooleanAsAttrPresenceCodec)

  // -- Events --

  /** Fired when the close button is pressed either with a click/tap or by using
  ...
  /** Defines the content to be displayed as graphical element within the
    * component.
    *
    * **Note:** If no icon is given, the default icon for the component type
    * will be used. The SAP-icons font provides numerous options.
    *
