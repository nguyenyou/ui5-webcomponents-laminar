...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distUploadCollectionMod.{UploadCollectionItemDeleteEventDetail,UploadCollectionSelectionChangeEventDetail}
...
object UploadCollection extends WebComponent("ui5-upload-collection") {
  ...
  type Ref = UploadCollectionComponent & dom.HTMLElement
   ...
   * Default: "None"
   */
  lazy val selectionMode: HtmlAttr[UploadCollectionSelectionMode] = htmlAttr("selection-mode", StringUnionCodec[UploadCollectionSelectionMode])
  ...
  * | ❌|✅|
   */
  lazy val onItemDelete: EventProp[Ui5CustomEvent[Ref] & EventDetail[UploadCollectionItemDeleteEventDetail]]  = new EventProp("item-delete")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[UploadCollectionSelectionChangeEventDetail]]  = new EventProp("selection-change")
