...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distDateRangePickerMod.{
...
object DateRangePicker extends WebComponent("ui5-daterange-picker") {
  ...
  type Ref = DateRangePickerComponent with dom.HTMLElement
  ...
  /** Determines the symbol which separates the dates. If not supplied, the
    * default time interval delimiter for the current locale will be used.
    *
    * Default: "-"
    */
