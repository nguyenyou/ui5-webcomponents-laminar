...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distMultiComboBoxItemGroupMod.MultiComboBoxItemGroup as MultiComboBoxItemGroupComponent
...
object MultiComboBoxItemGroup extends WebComponent("ui5-mcb-item-group") {
  ...
  type Ref = MultiComboBoxItemGroupComponent & dom.HTMLElement
  ...
  * | ✅|✅|
   */
  lazy val onMoveOver: EventProp[Ui5CustomEvent[Ref] & EventDetail[ListItemGroupMoveEventDetail]]  = new EventProp("move-over")
