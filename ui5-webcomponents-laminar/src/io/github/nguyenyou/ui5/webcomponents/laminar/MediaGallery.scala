...
object MediaGallery extends WebComponent("ui5-media-gallery") {
  ...
  /** If enabled, a `display-area-click` event is fired when the user clicks or
    * taps on the display area.
    *
    * The display area is the central area that contains the enlarged content of
  ...
  lazy val layout: HtmlAttr[MediaGalleryLayout] =
    htmlAttr("layout", StringUnionCodec[MediaGalleryLayout])
  type MediaGalleryLayout = "Auto" | "Vertical" | "Horizontal"

  /** Determines the horizontal alignment of the thumbnails menu vs. the central
    * display area.
    *
    * Default: "Left"
    */
  lazy val menuHorizontalAlign: HtmlAttr[MediaGalleryMenuHorizontalAlign] =
    htmlAttr(
      ...
      StringUnionCodec[MediaGalleryMenuHorizontalAlign]
    )
  type MediaGalleryMenuHorizontalAlign = "Left" | "Right"

  /** Determines the vertical alignment of the thumbnails menu vs. the central
    * display area.
    *
    * Default: "Bottom"
    */
  lazy val menuVerticalAlign: HtmlAttr[MediaGalleryMenuVerticalAlign] =
    htmlAttr(
      "menu-vertical-align",
      StringUnionCodec[MediaGalleryMenuVerticalAlign]
    )
  type MediaGalleryMenuVerticalAlign = "Top" | "Bottom"

  /** If set to `true`, all thumbnails are rendered in a scrollable container.
    * If `false`, only up to five thumbnails are rendered, followed by an
    * overflow button that shows the count of the remaining thumbnails.
    *
    * Default: false
    */
  ...
  /** Fired when the display area is clicked. The display area is the central
    * area that contains the enlarged content of the currently selected item.
    *
    * | cancelable | bubbles |
    * |:----------:|:-------:|
    * |     ❌      |    ✅    |
    */
  lazy val onDisplayAreaClick: EventProp[Ui5CustomEvent[Ref]] = new EventProp(
    "display-area-click"
  )
  ...
  /** Fired when the thumbnails overflow button is clicked.
    ...
    * |     ❌      |    ✅    |
    */
  lazy val onOverflowClick: EventProp[Ui5CustomEvent[Ref]] = new EventProp(
    "overflow-click"
  )
  ...
  lazy val onSelectionChange: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[MediaGallerySelectionChangeEventDetail]
