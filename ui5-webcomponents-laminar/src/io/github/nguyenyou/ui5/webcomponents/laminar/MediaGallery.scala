...
object MediaGallery extends WebComponent("ui5-media-gallery") {
   ...
   * Default: "Left"
   */
  lazy val menuHorizontalAlign: HtmlAttr[MediaGalleryMenuHorizontalAlign] = htmlAttr("menu-horizontal-align", StringUnionCodec[MediaGalleryMenuHorizontalAlign])
  /**
   ...
   * Default: "Bottom"
   */
  lazy val menuVerticalAlign: HtmlAttr[MediaGalleryMenuVerticalAlign] = htmlAttr("menu-vertical-align", StringUnionCodec[MediaGalleryMenuVerticalAlign])
  /**
  ...
  * | ❌|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[MediaGallerySelectionChangeEventDetail]]  = new EventProp("selection-change")
