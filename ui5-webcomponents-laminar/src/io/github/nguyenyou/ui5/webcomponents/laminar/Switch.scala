...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTypesSwitchDesignMod.SwitchDesign
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distSwitchMod.{
...
object Switch extends WebComponent("ui5-switch") {
  ...
  /** Sets the accessible ARIA name of the component.
    *
    * **Note**: We recommend that you set an accessibleNameRef pointing to an
    * external label or at least an `accessibleName`. Providing an
    * `accessibleNameRef` or an `accessibleName` is mandatory in the cases when
  ...
  /** Defines if the component is checked.
    ...
    * cliking the component, or by pressing the `Enter` or `Space` key.
    *
    * Default: false
    */
  ...
  /** Defines the component design.
    *
    * **Note:** If `Graphical` type is set, positive and negative icons will
    * replace the `textOn` and `textOff`.
    *
    * Default: "Textual"
    */
  lazy val design: HtmlAttr[SwitchDesign] =
    htmlAttr("design", StringUnionCodec[SwitchDesign])
  ...
  /** Defines the text, displayed when the component is not checked.
    *
    * **Note:** We recommend using short texts, up to 3 letters (larger texts
    * would be cut off).
    *
    * Default: undefined
    */
  ...
  /** Defines the tooltip of the component.
    *
    * **Note:** If applicable an external label reference should always be the
    * preferred option to provide context to the `Switch` component over a
    * tooltip.
    *
    * **Note:** Available since
