...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distFileUploaderMod.{FileUploaderChangeEventDetail,FileUploaderFileSizeExceedEventDetail}
...
object FileUploader extends WebComponent("ui5-file-uploader") {
  ...
  * | ❌|✅|
   */
  lazy val onChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[FileUploaderChangeEventDetail]]  = new EventProp("change")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onFileSizeExceed: EventProp[Ui5CustomEvent[Ref] & EventDetail[FileUploaderFileSizeExceedEventDetail]]  = new EventProp("file-size-exceed")
