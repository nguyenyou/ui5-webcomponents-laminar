...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distSelectMod.{SelectChangeEventDetail,SelectLiveChangeEventDetail}
...
object Select extends WebComponent("ui5-select") {
  ...
  * | ❌|✅|
   */
  lazy val onLiveChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[SelectLiveChangeEventDetail]]  = new EventProp("live-change")
  /**
