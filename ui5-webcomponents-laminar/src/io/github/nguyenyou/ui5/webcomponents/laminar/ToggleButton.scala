...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTypesButtonAccessibleRoleMod.ButtonAccessibleRole
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTypesButtonDesignMod.ButtonDesign
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTypesButtonTypeMod.ButtonType
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distToggleButtonMod.{
...
object ToggleButton extends WebComponent("ui5-toggle-button") {
  ...
  /** Describes the accessibility role of the button.
    *
    * **Note:** Use <code>ButtonAccessibleRole.Link</code> role only with a
    * press handler, which performs a navigation. In all other scenarios the
    * default button semantics are recommended.
    *
    * **Note:** Available since
    * [v1.23](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.23) of
    * **@ui5/webcomponents**.
    *
    * Default: "Button"
    */
  ...
  /** Determines whether the component is displayed as pressed.
    ...
    * Default: false
    */
  lazy val pressed: HtmlAttr[Boolean] =
    htmlAttr("pressed", BooleanAsAttrPresenceCodec)

  /** When set to `true`, the component will automatically submit the nearest
    * HTML form element on `press`.
    *
    ...
    * Default: false
    *
    * Deprecated: Set the "type" property to "Submit" to achieve the same
    * result. The "submits" property is ignored if "type" is set to any value
    * other than "Button".
    */
  ...
  lazy val tpe: HtmlAttr[ButtonType] =
    htmlAttr("type", StringUnionCodec[ButtonType])
