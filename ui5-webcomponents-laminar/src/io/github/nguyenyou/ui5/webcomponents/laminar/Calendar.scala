...
object Calendar extends WebComponent("ui5-calendar") {
   ...
   * Default: "Single"
   */
  lazy val selectionMode: HtmlAttr[CalendarSelectionMode] = htmlAttr("selection-mode", StringUnionCodec[CalendarSelectionMode])
  ...
  * | ✅|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[CalendarSelectionChangeEventDetail]]  = new EventProp("selection-change")
