...
object Carousel extends WebComponent("ui5-carousel") {
   ...
   * Default: "Content"
   */
  lazy val arrowsPlacement: HtmlAttr[CarouselArrowsPlacement] = htmlAttr("arrows-placement", StringUnionCodec[CarouselArrowsPlacement])
  /**
   ...
   * Default: "Translucent"
   */
  lazy val backgroundDesign: HtmlAttr[BackgroundDesign] = htmlAttr("background-design", StringUnionCodec[BackgroundDesign])
  /**
   ...
   * Default: "Solid"
   */
  lazy val pageIndicatorBackgroundDesign: HtmlAttr[BackgroundDesign] = htmlAttr("page-indicator-background-design", StringUnionCodec[BackgroundDesign])
  /**
   ...
   * Default: "Solid"
   */
  lazy val pageIndicatorBorderDesign: HtmlAttr[BorderDesign] = htmlAttr("page-indicator-border-design", StringUnionCodec[BorderDesign])
  /**
   ...
   * Default: "Default"
   */
  lazy val pageIndicatorType: HtmlAttr[CarouselPageIndicatorType] = htmlAttr("page-indicator-type", StringUnionCodec[CarouselPageIndicatorType])
  ...
  * | ❌|✅|
   */
  lazy val onNavigate: EventProp[Ui5CustomEvent[Ref] & EventDetail[CarouselNavigateEventDetail]]  = new EventProp("navigate")
