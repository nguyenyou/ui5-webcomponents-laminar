...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distBarcodeScannerDialogMod.{BarcodeScannerDialogScanErrorEventDetail,BarcodeScannerDialogScanSuccessEventDetail}
...
object BarcodeScannerDialog extends WebComponent("ui5-barcode-scanner-dialog") {
  ...
  * | ❌|✅|
   */
  lazy val onScanError: EventProp[Ui5CustomEvent[Ref] & EventDetail[BarcodeScannerDialogScanErrorEventDetail]]  = new EventProp("scan-error")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onScanSuccess: EventProp[Ui5CustomEvent[Ref] & EventDetail[BarcodeScannerDialogScanSuccessEventDetail]]  = new EventProp("scan-success")
