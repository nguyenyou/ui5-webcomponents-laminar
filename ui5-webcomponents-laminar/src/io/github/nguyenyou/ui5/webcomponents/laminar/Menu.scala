...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distMenuMod.{MenuBeforeCloseEventDetail,MenuBeforeOpenEventDetail,MenuItemClickEventDetail}
...
object Menu extends WebComponent("ui5-menu") {
   ...
   * Default: "Start"
   */
  lazy val horizontalAlign: HtmlAttr[PopoverHorizontalAlign] = htmlAttr("horizontal-align", StringUnionCodec[PopoverHorizontalAlign])
  /**
  ...
  * | ✅|✅|
   */
  lazy val onBeforeClose: EventProp[Ui5CustomEvent[Ref] & EventDetail[MenuBeforeCloseEventDetail]]  = new EventProp("before-close")
  /**
  ...
  * | ✅|✅|
   */
  lazy val onBeforeOpen: EventProp[Ui5CustomEvent[Ref] & EventDetail[MenuBeforeOpenEventDetail]]  = new EventProp("before-open")
  /**
  ...
  * | ✅|❌|
   */
  lazy val onItemClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[MenuItemClickEventDetail]]  = new EventProp("item-click")
  /**
