...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distLinkMod.{LinkAccessibilityAttributes,LinkClickEventDetail}
...
object Link extends WebComponent("ui5-link") {
   ...
   * Default: "Link"
   */
  lazy val accessibleRole: HtmlAttr[LinkAccessibleRole] = htmlAttr("accessible-role", StringUnionCodec[LinkAccessibleRole])
  /**
   ...
   * Default: "Normal"
   */
  lazy val interactiveAreaSize: HtmlAttr[InteractiveAreaSize] = htmlAttr("interactive-area-size", StringUnionCodec[InteractiveAreaSize])
  /**
