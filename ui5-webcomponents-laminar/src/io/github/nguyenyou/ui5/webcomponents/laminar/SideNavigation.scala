...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distSideNavigationMod.SideNavigation as SideNavigationComponent
...
object SideNavigation extends WebComponent("ui5-side-navigation") {
  ...
  type Ref = SideNavigationComponent & dom.HTMLElement
  ...
  * | ✅|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[SideNavigationSelectionChangeEventDetail]]  = new EventProp("selection-change")
