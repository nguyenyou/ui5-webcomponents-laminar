...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTagMod.{
  Tag as TagComponent
}
...
object Tag extends WebComponent("ui5-tag") {
  ...
  /** Defines the design type of the component.
    ...
    * Default: "Neutral"
    */
  lazy val design: HtmlAttr[TagDesign] =
    htmlAttr("design", StringUnionCodec[TagDesign])
  type TagDesign = "Set1" | "Set2" | "Neutral" | "Information" | "Positive" |
    "Negative" | "Critical"
  ...
  /** Defines if the default state icon is shown.
    ...
    * Default: false
    */
  lazy val hideStateIcon: HtmlAttr[Boolean] =
    htmlAttr("hide-state-icon", BooleanAsAttrPresenceCodec)
