...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distTimelineMod.{Timeline as TimelineComponent}
...
object Timeline extends WebComponent("ui5-timeline") {
  ...
  /** Defines whether the Timeline will have growing capability either by pressing a "More" button, or via user scroll.
    * In both cases a `load-more` event is fired.
    *
    * Available options:
    *
