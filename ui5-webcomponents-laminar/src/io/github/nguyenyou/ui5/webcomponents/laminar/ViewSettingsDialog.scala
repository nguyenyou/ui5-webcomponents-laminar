...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distViewSettingsDialogMod.{ViewSettingsDialogCancelEventDetail,ViewSettingsDialogConfirmEventDetail}
...
object ViewSettingsDialog extends WebComponent("ui5-view-settings-dialog") {
  ...
  * | ❌|✅|
   */
  lazy val onCancel: EventProp[Ui5CustomEvent[Ref] & EventDetail[ViewSettingsDialogCancelEventDetail]]  = new EventProp("cancel")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onConfirm: EventProp[Ui5CustomEvent[Ref] & EventDetail[ViewSettingsDialogConfirmEventDetail]]  = new EventProp("confirm")
  /**
