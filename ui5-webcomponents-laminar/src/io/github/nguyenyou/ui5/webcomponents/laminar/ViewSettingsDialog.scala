...
object ViewSettingsDialog extends WebComponent("ui5-view-settings-dialog") {
  ...
  /** Fired when cancel button is activated.
    ...
    * |     ❌      |    ✅    |
    */
  lazy val onCancel: EventProp[Ui5CustomEvent[Ref] & EventDetail[ViewSettingsDialogCancelEventDetail]] = new EventProp(
    "cancel"
  )
  ...
  /** Fired when confirmation button is activated.
    ...
    * |     ❌      |    ✅    |
    */
  lazy val onConfirm: EventProp[Ui5CustomEvent[Ref] & EventDetail[ViewSettingsDialogConfirmEventDetail]] =
  ...
  /** Defines the `filterItems` list.
    *
    * **Note:** If you want to use this slot, you need to import used item: `import
    * "@ui5/webcomponents-fiori/dist/FilterItem.js";`
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="filterItems"`).
  ...
  /** Defines the list of items against which the user could sort data.
    ...
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="sortItems"`).
    * Since you can't change the DOM order of slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when facing problems with the reading order of
    * screen readers.
    *
