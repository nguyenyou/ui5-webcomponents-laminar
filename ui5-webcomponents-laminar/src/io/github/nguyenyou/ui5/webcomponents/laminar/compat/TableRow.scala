...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsCompat.distTypesTableRowTypeMod.TableRowType
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsCompat.distTableRowMod.{
...
object TableRow extends WebComponent("ui5-table-row") {
  ...
  /** Defines the visual indication and behavior of the component.
    *
    * **Note:** When set to `Active`, the item will provide visual response upon
    * press, while with type `Inactive`-will not.
    *
    * **Note:** Available since
    * [v2.0.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v2.0.0) of
    * **@ui5/webcomponents-compat**.
    ...
    * Default: "Inactive"
    */
  lazy val tpe: HtmlAttr[TableRowType] =
    htmlAttr("type", StringUnionCodec[TableRowType])
