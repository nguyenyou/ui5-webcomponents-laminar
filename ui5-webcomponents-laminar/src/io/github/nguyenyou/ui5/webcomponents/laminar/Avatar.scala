...
object Avatar extends WebComponent("ui5-avatar") {
  ...
  /** Defines the background color of the desired image. If `colorScheme` is set to `Auto`, the avatar will be displayed
    * with the `Accent6` color.
    *
    * Default: "Auto"
    */
  ...
  /** Defines the optional badge that will be used for visual affordance.
    *
    * **Note:** While the slot allows for custom badges, to achieve the Fiori design, you can use the `Tag` with `Icon`
