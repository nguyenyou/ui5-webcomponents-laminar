...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distAvatarMod.{
...
object Avatar extends WebComponent("ui5-avatar") {
  ...
  /** Defines the text alternative of the component. If not provided a default
    * text alternative will be set, if present.
    *
    * Default: undefined
    */
  ...
  /** Defines the background color of the desired image. If `colorScheme` is set
    * to `Auto`, the avatar will be displayed with the `Accent6` color.
    *
    * Default: "Auto"
    */
  lazy val colorScheme: HtmlAttr[AvatarColorScheme] =
    htmlAttr("color-scheme", StringUnionCodec[AvatarColorScheme])
  type AvatarColorScheme = "Auto" | "Accent1" | "Accent2" | "Accent3" |
    "Accent4" | "Accent5" | "Accent6" | "Accent7" | "Accent8" | "Accent9" |
    "Accent10" | "Placeholder"
  ...
  /** Defines the name of the fallback icon, which should be displayed in the
    * following cases:
    *
    *   - If the initials are not valid (more than 3 letters, unsupported
    *     languages or empty initials).
    *   - If there are three initials and they do not fit in the shape (e.g. WWW
    *     for some of the sizes).
    *   - If the image src is wrong.
    *
    * **Note:** If not set, a default fallback icon "employee" is displayed.
    *
    * **Note:** You should import the desired icon first, then use its name as
    * "fallback-icon".
    *
    ...
    * Default: "employee"
    */
  lazy val fallbackIcon: HtmlAttr[String] =
    htmlAttr("fallback-icon", StringAsIsCodec)
  ...
  /** Defines the name of the UI5 Icon, that will be displayed.
    ...
    *
    * **Note:** If no icon or an empty one is provided, by default the
    * "employee" icon should be displayed.
    *
    * See all the available icons in the [Icon
    * Explorer](https://sdk.openui5.org/test-resources/sap/m/demokit/iconExplorer/webapp/index.html).
    *
  ...
  /** Defines if the avatar is interactive (focusable and pressable).
    *
    * **Note:** This property won't have effect if the `disabled` property is
    * set to `true`.
    *
    * Default: false
    */
  ...
  /** Defines the shape of the component.
    ...
    * Default: "Circle"
    */
  lazy val shape: HtmlAttr[AvatarShape] =
    htmlAttr("shape", StringUnionCodec[AvatarShape])
  ...
  /** Defines predefined size of the component.
    ...
    * Default: "S"
    */
  lazy val size: HtmlAttr[AvatarSize] =
    htmlAttr("size", StringUnionCodec[AvatarSize])
  ...
  /** Defines the optional badge that will be used for visual affordance.
    *
    * **Note:** While the slot allows for custom badges, to achieve the Fiori
    * design, you can use the `Tag` with `Icon` in the corresponding `icon`
    ...
    * attribute (`slot="badge"`). Since you can't change the DOM order of slots
