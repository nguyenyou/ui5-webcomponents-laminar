...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distDynamicPageTitleMod.{
  DynamicPageTitle as DynamicPageTitleComponent
}
...
object DynamicPageTitle extends WebComponent("ui5-dynamic-page-title") {
  ...
  @JSImport(
    "@ui5/webcomponents-fiori/dist/DynamicPageTitle.js",
    JSImport.Default
  )
  @js.native
  ...
  /** Defines the bar with actions in the Dynamic page title.
    ...
    * attribute (`slot="actionsBar"`). Since you can't change the DOM order of
  ...
  /** Defines the content of the breadcrumbs inside Dynamic Page Title.
    ...
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="breadcrumbs"`). Since you can't change the DOM order of
    * slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when
    * facing problems with the reading order of screen readers.
    *
  ...
  /** Defines the content of the Heading of the Dynamic Page.
    *
    * The font size of the title within the `heading` slot can be adjusted to
    * the recommended values using the following CSS variables:
    *
    ...
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="heading"`). Since you can't change the DOM order of
    * slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when
    * facing problems with the reading order of screen readers.
    *
  ...
  /** Defines the bar with navigation actions in the Dynamic page title.
    ...
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="navigationBar"`). Since you can't change the DOM order
  ...
  /** Defines the heading that is shown only when the header is snapped.
    ...
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="snappedHeading"`). Since you can't change the DOM order
    * of slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when
    * facing problems with the reading order of screen readers.
    *
  ...
  /** Defines the content of the title that is shown only when the header is
    * snapped.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot)
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="snappedSubheading"`). Since you can't change the DOM
  ...
  /** Defines the content of the snapped title on mobile devices.
    *
    * This slot is displayed only when the `DynamicPageTitle` is in the snapped
    * state on mobile devices. It should be used to provide a simplified,
    * single-line title that takes up less space on smaller screens.
    *
    * **Note:**
    *   - The content set in this slot **overrides** all other content set in
    *     the `DynamicPageTitle` slots when displayed.
    ...
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="snappedTitleOnMobile"`). Since you can't change the DOM
    * order of slots when declaring them within a prop, it might prove
    * beneficial to manually mount them as part of the component's children,
    * especially when facing problems with the reading order of screen readers.
    *
    ...
    * [v2.3.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v2.3.0) of
    * **@ui5/webcomponents-fiori**.
    */
  lazy val snappedTitleOnMobile: Slot = new Slot("snappedTitleOnMobile")

  /** Defines the content of the title that is shown only when the header is not
    * snapped.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot)
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="subheading"`). Since you can't change the DOM order of
    * slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when
    * facing problems with the reading order of screen readers.
    *
