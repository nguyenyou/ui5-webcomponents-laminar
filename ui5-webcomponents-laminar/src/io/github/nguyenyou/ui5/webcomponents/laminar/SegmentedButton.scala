...
object SegmentedButton extends WebComponent("ui5-segmented-button") {
   ...
   * Default: "Single"
   */
  lazy val selectionMode: HtmlAttr[SegmentedButtonSelectionMode] = htmlAttr("selection-mode", StringUnionCodec[SegmentedButtonSelectionMode])
  ...
  * | ❌|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[SegmentedButtonSelectionChangeEventDetail]]  = new EventProp("selection-change")
