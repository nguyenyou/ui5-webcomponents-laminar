...
object ShellBar extends WebComponent("ui5-shellbar") {
  ...
  * | ❌|✅|
   */
  lazy val onContentItemVisibilityChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarContentItemVisibilityChangeEventDetail]]  = new EventProp("content-item-visibility-change")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onLogoClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarLogoClickEventDetail]]  = new EventProp("logo-click")
  /**
  ...
  * | ✅|✅|
   */
  lazy val onMenuItemClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarMenuItemClickEventDetail]]  = new EventProp("menu-item-click")
  /**
  ...
  * | ✅|✅|
   */
  lazy val onNotificationsClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarNotificationsClickEventDetail]]  = new EventProp("notifications-click")
  /**
  ...
  * | ✅|✅|
   */
  lazy val onProductSwitchClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarProductSwitchClickEventDetail]]  = new EventProp("product-switch-click")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onProfileClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarProfileClickEventDetail]]  = new EventProp("profile-click")
  /**
  ...
  * | ✅|✅|
   */
  lazy val onSearchButtonClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarSearchButtonEventDetail]]  = new EventProp("search-button-click")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onSearchFieldToggle: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarSearchFieldToggleEventDetail]]  = new EventProp("search-field-toggle")
