...
object ShellBar extends WebComponent("ui5-shellbar") {
  ...
  type Ref = ShellBarComponent & dom.HTMLElement
  ...
  /** Defines the `notificationsCount`, displayed in the notification icon top-right corner.
    ...
    * Default: undefined
    */
  lazy val notificationsCount: HtmlAttr[String] = htmlAttr("notifications-count", StringAsIsCodec)
  ...
  /** Defines the `primaryTitle`.
    ...
    * Default: undefined
    */
  lazy val primaryTitle: HtmlAttr[String] = htmlAttr("primary-title", StringAsIsCodec)
  ...
  /** Defines the `secondaryTitle`.
    ...
    * Default: undefined
    */
  lazy val secondaryTitle: HtmlAttr[String] = htmlAttr("secondary-title", StringAsIsCodec)

  /** Defines, if the notification icon would be displayed.
    *
    * Default: false
    */
  lazy val showNotifications: HtmlAttr[Boolean] = htmlAttr("show-notifications", BooleanAsAttrPresenceCodec)

  /** Defines, if the product switch icon would be displayed.
    *
    * Default: false
    */
  lazy val showProductSwitch: HtmlAttr[Boolean] = htmlAttr("show-product-switch", BooleanAsAttrPresenceCodec)
  ...
  /** Fired, when an item from the content slot is hidden or shown. **Note:** The `content-item-visibility-change` event
    * is in an experimental state and is a subject to change.
    *
    ...
    * |     ❌      |    ✅    |
    */
  lazy val onContentItemVisibilityChange
      : EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarContentItemVisibilityChangeEventDetail]] = new EventProp(
  ...
  /** Fired, when the logo is activated.
    ...
    * |     ❌      |    ✅    |
    */
  lazy val onLogoClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarLogoClickEventDetail]] = new EventProp(
    "logo-click"
  )
  ...
  /** Fired, when a menu item is activated
    ...
    * |     ✅      |    ✅    |
    */
  lazy val onMenuItemClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarMenuItemClickEventDetail]] =
  ...
  /** Fired, when the notification icon is activated.
    ...
    * |     ✅      |    ✅    |
    */
  lazy val onNotificationsClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarNotificationsClickEventDetail]] =
  ...
  /** Fired, when the product switch icon is activated.
    ...
    * |     ✅      |    ✅    |
    */
  lazy val onProductSwitchClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarProductSwitchClickEventDetail]] =
  ...
  /** Fired, when the profile slot is present.
    ...
    * |     ❌      |    ✅    |
    */
  lazy val onProfileClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[ShellBarProfileClickEventDetail]] =
  ...
  /** Defines the assistant slot.
    ...
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="assistant"`).
  ...
  /** Defines the branding slot. The `ShellBarBranding` component is intended to be placed inside this slot. Content
    * placed here takes precedence over the `primaryTitle` property and the `logo` content slot.
    *
    * **Note:** The `branding` slot is in an experimental state and is a subject to change.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="branding"`).
    * Since you can't change the DOM order of slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when facing problems with the reading order of
    * screen readers.
    *
    ...
    * **@ui5/webcomponents-fiori**.
    */
  lazy val branding: Slot = new Slot("branding")

  /** Define the items displayed in the content area.
    *
    * Use the `data-hide-order` attribute with numeric value to specify the order of the items to be hidden when the
    * space is not enough. Lower values will be hidden first.
    *
    * **Note:** The `content` slot is in an experimental state and is a subject to change.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="content"`).
    * Since you can't change the DOM order of slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when facing problems with the reading order of
    * screen readers.
    *
  ...
  /** Defines the items displayed in menu after a click on a start button.
    ...
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="menuItems"`).
    * Since you can't change the DOM order of slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when facing problems with the reading order of
    * screen readers.
    *
  ...
  /** You can pass `ui5-avatar` to set the profile image/icon. If no profile slot is set - profile will be excluded from
    * actions.
    *
    * **Note:** We recommend not using the `size` attribute of `ui5-avatar` because it should have specific size by
    * design in the context of `ShellBar` profile.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="profile"`).
    * Since you can't change the DOM order of slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when facing problems with the reading order of
    * screen readers.
    *
  ...
  /** Defines the `ui5-input`, that will be used as a search field.
    ...
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="searchField"`).
    * Since you can't change the DOM order of slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when facing problems with the reading order of
    * screen readers.
    *
  ...
  /** Defines a `ui5-button` in the bar that will be placed in the beginning. We encourage this slot to be used for a
    * menu button. It gets overstyled to match ShellBar's styling.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="startButton"`).
    * Since you can't change the DOM order of slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when facing problems with the reading order of
    * screen readers.
    *
