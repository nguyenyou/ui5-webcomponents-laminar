...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distMultiComboBoxMod.MultiComboBox as MultiComboBoxComponent
...
object MultiComboBox extends WebComponent("ui5-multi-combobox") {
  ...
  * | ✅|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[MultiComboBoxSelectionChangeEventDetail]]  = new EventProp("selection-change")
