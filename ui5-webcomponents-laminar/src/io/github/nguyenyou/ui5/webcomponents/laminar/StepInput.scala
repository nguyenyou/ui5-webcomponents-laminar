...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distStepInputMod.{
  StepInput as StepInputComponent
}
...
object StepInput extends WebComponent("ui5-step-input") {
  ...
  /** Determines the number of digits after the decimal point of the component.
    ...
    * Default: 0
    */
  lazy val valuePrecision: HtmlAttr[Double] =
    htmlAttr("value-precision", DoubleAsStringCodec)
  ...
  lazy val onValueStateChange: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[StepInputValueStateChangeEventDetail]
