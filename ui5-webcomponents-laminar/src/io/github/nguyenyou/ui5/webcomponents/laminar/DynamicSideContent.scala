...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distDynamicSideContentMod.{DynamicSideContentAccessibilityAttributes,DynamicSideContentLayoutChangeEventDetail}
...
object DynamicSideContent extends WebComponent("ui5-dynamic-side-content") {
   ...
   */
  lazy val sideContentFallDown: HtmlAttr[SideContentFallDown] = htmlAttr("side-content-fall-down", StringUnionCodec[SideContentFallDown])
  /**
   ...
   * Default: "End"
   */
  lazy val sideContentPosition: HtmlAttr[SideContentPosition] = htmlAttr("side-content-position", StringUnionCodec[SideContentPosition])
  /**
   * Defines on which breakpoints the side content is visible.
   *
   * Default: "ShowAboveS"
   */
  lazy val sideContentVisibility: HtmlAttr[SideContentVisibility] = htmlAttr("side-content-visibility", StringUnionCodec[SideContentVisibility])
  ...
  * | ❌|✅|
   */
  lazy val onLayoutChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[DynamicSideContentLayoutChangeEventDetail]]  = new EventProp("layout-change")
