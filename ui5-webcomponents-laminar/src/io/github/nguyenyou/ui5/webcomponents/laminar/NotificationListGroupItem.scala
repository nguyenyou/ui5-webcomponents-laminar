...
object NotificationListGroupItem extends WebComponent("ui5-li-notification-group") {
  ...
  type Ref = NotificationListGroupItemComponent & dom.HTMLElement
   ...
   * Default: "None"
   */
  lazy val growing: HtmlAttr[NotificationListGrowingMode] = htmlAttr("growing", StringUnionCodec[NotificationListGrowingMode])
  /**
