...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTreeMod.{TreeItemClickEventDetail,TreeItemDeleteEventDetail,TreeItemMouseoutEventDetail,TreeItemMouseoverEventDetail,TreeItemToggleEventDetail,TreeSelectionChangeEventDetail}
...
object Tree extends WebComponent("ui5-tree") {
  ...
  * | ✅|✅|
   */
  lazy val onItemClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[TreeItemClickEventDetail]]  = new EventProp("item-click")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onItemDelete: EventProp[Ui5CustomEvent[Ref] & EventDetail[TreeItemDeleteEventDetail]]  = new EventProp("item-delete")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onItemMouseout: EventProp[Ui5CustomEvent[Ref] & EventDetail[TreeItemMouseoutEventDetail]]  = new EventProp("item-mouseout")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onItemMouseover: EventProp[Ui5CustomEvent[Ref] & EventDetail[TreeItemMouseoverEventDetail]]  = new EventProp("item-mouseover")
  /**
  ...
  * | ✅|✅|
   */
  lazy val onItemToggle: EventProp[Ui5CustomEvent[Ref] & EventDetail[TreeItemToggleEventDetail]]  = new EventProp("item-toggle")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[TreeSelectionChangeEventDetail]]  = new EventProp("selection-change")
