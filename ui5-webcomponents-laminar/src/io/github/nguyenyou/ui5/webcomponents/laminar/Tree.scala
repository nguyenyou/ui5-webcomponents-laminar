...
object Tree extends WebComponent("ui5-tree") {
  ...
  /** Defines the accessible name of the component.
    *
    * **Note:** Available since
    * [v1.8.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.8.0) of
    * **@ui5/webcomponents**.
    *
    * Default: undefined
    */
  ...
  /** Defines the selection mode of the component. Since the tree uses a `List`
    * to display its structure, the tree modes are exactly the same as the list
    * modes, and are all applicable.
    *
    * Default: "None"
    */
  ...
  lazy val onItemClick
      : EventProp[Ui5CustomEvent[Ref] & EventDetail[TreeItemClickEventDetail]] =
  ...
  lazy val onItemDelete: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[TreeItemDeleteEventDetail]
  ...
  /** Fired when the mouse cursor leaves the tree item borders.
    ...
    * |     ❌      |    ✅    |
    */
  lazy val onItemMouseout: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[TreeItemMouseoutEventDetail]
  ] = new EventProp("item-mouseout")
  ...
  /** Fired when the mouse cursor enters the tree item borders.
    ...
    * |     ❌      |    ✅    |
    */
  lazy val onItemMouseover: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[TreeItemMouseoverEventDetail]
  ] = new EventProp("item-mouseover")

  /** Fired when a tree item is expanded or collapsed.
    *
    * **Note:** You can call `preventDefault()` on the event object to suppress
    * the event, if needed. This may be handy for example if you want to
    * dynamically load tree items upon the user expanding a node. Even if you
    * prevented the event's default behavior, you can always manually call
    * `toggle()` on a tree item.
    *
    * **Note:** Call `event.preventDefault()` inside the handler of this event
    * to prevent its default action/s.
    *
  ...
  lazy val onItemToggle: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[TreeItemToggleEventDetail]
  ] = new EventProp("item-toggle")

  /** Fired when selection is changed by user interaction in `Single`,
    * `SingleStart`, `SingleEnd` and `Multiple` modes.
    *
    * | cancelable | bubbles |
    * |:----------:|:-------:|
    * |     ❌      |    ✅    |
  ...
  lazy val onSelectionChange: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[TreeSelectionChangeEventDetail]
  ...
  /** Defines the component header.
    *
    * **Note:** When the `header` slot is set, the `headerText` property is
    * ignored.
    *
