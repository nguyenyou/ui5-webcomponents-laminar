...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distDateTimePickerMod.DateTimePicker as DateTimePickerComponent
import org.scalajs.dom

import scala.scalajs.js
import scala.scalajs.js.annotation.*

object DateTimePicker extends WebComponent("ui5-datetime-picker") {
  ...
  /** Fired before the value state of the component is updated internally. The event is preventable, meaning that if
    ...
    * |     ✅      |    ✅    |
    */
  lazy val onValueStateChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[DatePickerValueStateChangeEventDetail]] =
