...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distColorPaletteItemMod.ColorPaletteItem as ColorPaletteItemComponent
...
object ColorPaletteItem extends WebComponent("ui5-color-palette-item") {
  ...
  type Ref = ColorPaletteItemComponent & dom.HTMLElement
