...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distRangeSliderMod.{
...
object RangeSlider extends WebComponent("ui5-range-slider") {
  ...
  /** Defines end point of a selection - position of a second handle on the
    * slider.
    *
    * Default: 100
    */
  lazy val endValue: HtmlAttr[Double] =
    htmlAttr("end-value", DoubleAsStringCodec)
  ...
  /** Defines start point of a selection - position of a first handle on the
    * slider.
    *
    * Default: 0
    */
  lazy val startValue: HtmlAttr[Double] =
    htmlAttr("start-value", DoubleAsStringCodec)
