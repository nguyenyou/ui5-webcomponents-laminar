...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTypesSemanticColorMod.SemanticColor
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTabMod.{
  Tab as TabComponent
}
...
object Tab extends WebComponent("ui5-tab") {
  ...
  /** Represents the "additionalText" text, which is displayed in the tab. In
    * the cases when in the same time there are tabs with icons and tabs without
    * icons, if a tab has no icon the "additionalText" is displayed larger.
    *
    * Default: undefined
    */
  ...
  /** Defines the component's design color.
    ...
    *
    * Available designs are: `"Default"`, `"Neutral"`, `"Positive"`,
    ...
    * Default: "Default"
    */
  lazy val design: HtmlAttr[SemanticColor] =
    htmlAttr("design", StringUnionCodec[SemanticColor])
  type SemanticColor = "Default" | "Positive" | "Negative" | "Critical" |
    "Neutral"
  ...
  /** Defines the icon source URI to be displayed as graphical element within
    * the component. The SAP-icons font provides numerous built-in icons. See
    * all the available icons in the [Icon
  ...
  /** Defines hierarchies with nested sub tabs.
    ...
    * attribute (`slot="items"`). Since you can't change the DOM order of slots
