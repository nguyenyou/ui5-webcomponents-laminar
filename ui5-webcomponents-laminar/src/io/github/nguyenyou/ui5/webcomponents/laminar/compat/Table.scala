...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsCompat.distTableMod.{TablePopinChangeEventDetail,TableSelectionChangeEventDetail}
...
object Table extends WebComponent("ui5-table") {
  ...
  * | ❌|✅|
   */
  lazy val onPopinChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[TablePopinChangeEventDetail]]  = new EventProp("popin-change")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onRowClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[TableRowClickEventDetail]]  = new EventProp("row-click")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[TableSelectionChangeEventDetail]]  = new EventProp("selection-change")
