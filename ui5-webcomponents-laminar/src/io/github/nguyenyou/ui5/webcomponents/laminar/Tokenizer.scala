...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distTokenizerMod.{TokenizerSelectionChangeEventDetail,TokenizerTokenDeleteEventDetail}
...
object Tokenizer extends WebComponent("ui5-tokenizer") {
  ...
  * | ❌|✅|
   */
  lazy val onSelectionChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[TokenizerSelectionChangeEventDetail]]  = new EventProp("selection-change")
  /**
  ...
  * | ❌|✅|
   */
  lazy val onTokenDelete: EventProp[Ui5CustomEvent[Ref] & EventDetail[TokenizerTokenDeleteEventDetail]]  = new EventProp("token-delete")
