...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distComboBoxItemMod.ComboBoxItem as ComboBoxItemComponent
...
object ComboBoxItem extends WebComponent("ui5-cb-item") {
  ...
  type Ref = ComboBoxItemComponent & dom.HTMLElement
