...
object Breadcrumbs extends WebComponent("ui5-breadcrumbs") {
  ...
  type Ref = BreadcrumbsComponent & dom.HTMLElement
  ...
  * | ✅|✅|
   */
  lazy val onItemClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[BreadcrumbsItemClickEventDetail]]  = new EventProp("item-click")
