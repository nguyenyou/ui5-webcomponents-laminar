...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distBreadcrumbsMod.{
...
object Breadcrumbs extends WebComponent("ui5-breadcrumbs") {
  ...
  /** Defines the visual appearance of the last BreadcrumbsItem.
    *
    * The Breadcrumbs supports two visual appearances for the last
    * BreadcrumbsItem:
    *   - "Standard" - displaying the last item as "current page" (bold and
    *     without separator)
    *   - "NoCurrentPage" - displaying the last item as a regular
    *     BreadcrumbsItem, followed by separator
    *
    * Default: "Standard"
    */
  lazy val design: HtmlAttr[BreadcrumbsDesign] =
    htmlAttr("design", StringUnionCodec[BreadcrumbsDesign])
  ...
  /** Determines the visual style of the separator between the breadcrumb items.
    ...
    * Default: "Slash"
    */
  lazy val separators: HtmlAttr[BreadcrumbsSeparator] =
    htmlAttr("separators", StringUnionCodec[BreadcrumbsSeparator])
  type BreadcrumbsSeparator = "Slash" | "BackSlash" | "DoubleBackSlash" |
    "DoubleGreaterThan" | "DoubleSlash" | "GreaterThan"

  // -- Events --

  /** Fires when a `BreadcrumbsItem` is clicked.
    *
    * **Note:** You can prevent browser location change by calling
  ...
  lazy val onItemClick: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[BreadcrumbsItemClickEventDetail]
