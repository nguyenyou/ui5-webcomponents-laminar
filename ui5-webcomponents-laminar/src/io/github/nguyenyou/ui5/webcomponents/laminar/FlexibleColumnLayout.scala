...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distFlexibleColumnLayoutMod.{FCLAccessibilityAttributes,FlexibleColumnLayoutLayoutChangeEventDetail}
...
object FlexibleColumnLayout extends WebComponent("ui5-flexible-column-layout") {
  ...
  * | ❌|✅|
   */
  lazy val onLayoutChange: EventProp[Ui5CustomEvent[Ref] & EventDetail[FlexibleColumnLayoutLayoutChangeEventDetail]]  = new EventProp("layout-change")
