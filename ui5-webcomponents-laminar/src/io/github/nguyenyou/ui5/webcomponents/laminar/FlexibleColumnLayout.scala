...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distFlexibleColumnLayoutMod.{
  FlexibleColumnLayout as FlexibleColumnLayoutComponent
}
...
object FlexibleColumnLayout extends WebComponent("ui5-flexible-column-layout") {
  ...
  /** Specifies if the user is allowed to change the columns layout by dragging
    ...
    * Default: false
    */
  lazy val disableResizing: HtmlAttr[Boolean] =
    htmlAttr("disable-resizing", BooleanAsAttrPresenceCodec)

  /** Defines the columns layout and their proportion.
    *
    * **Note:** The layout also depends on the screen size - one column for
    * screens smaller than 599px, two columns between 599px and 1023px and three
    * columns for sizes bigger than 1023px.
    *
    * **For example:** layout=`TwoColumnsStartExpanded` means the layout will
    * display up to two columns in 67%/33% proportion.
    *
    * Default: "OneColumn"
    */
  lazy val layout: HtmlAttr[FCLLayout] =
    htmlAttr("layout", StringUnionCodec[FCLLayout])
  type FCLLayout = "OneColumn" | "TwoColumnsStartExpanded" |
    "TwoColumnsMidExpanded" | "ThreeColumnsMidExpanded" |
    "ThreeColumnsEndExpanded" | "ThreeColumnsStartExpandedEndHidden" |
    "ThreeColumnsMidExpandedEndHidden" | "ThreeColumnsStartHiddenMidExpanded" |
    "ThreeColumnsStartHiddenEndExpanded" | "MidColumnFullScreen" |
    "EndColumnFullScreen"

  // -- Events --

  /** Fired when the layout changes via user interaction by dragging the
    * separators or by changing the component size due to resizing.
    *
    * | cancelable | bubbles |
    * |:----------:|:-------:|
    * |     ❌      |    ✅    |
  ...
  lazy val onLayoutChange: EventProp[
    Ui5CustomEvent[Ref] &
      EventDetail[FlexibleColumnLayoutLayoutChangeEventDetail]
  ...
  /** Defines the content in the end column.
    ...
    * attribute (`slot="endColumn"`). Since you can't change the DOM order of
  ...
  /** Defines the content in the middle column.
    ...
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="midColumn"`). Since you can't change the DOM order of
    * slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when
    * facing problems with the reading order of screen readers.
    *
  ...
  /** Defines the content in the start column.
    ...
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="startColumn"`). Since you can't change the DOM order of
    * slots when declaring them within a prop, it might prove beneficial to
    * manually mount them as part of the component's children, especially when
    * facing problems with the reading order of screen readers.
    *
