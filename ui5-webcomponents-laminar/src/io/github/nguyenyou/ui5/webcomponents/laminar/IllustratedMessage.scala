...
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distTypesIllustrationMessageDesignMod.IllustrationMessageDesign
import io.github.nguyenyou.ui5.webcomponents.ui5WebcomponentsFiori.distIllustratedMessageMod.{
  IllustratedMessage as IllustratedMessageComponent
}
...
object IllustratedMessage extends WebComponent("ui5-illustrated-message") {
  ...
  @JSImport(
    "@ui5/webcomponents-fiori/dist/IllustratedMessage.js",
    JSImport.Default
  )
  @js.native
  ...
  /** Receives id(or many ids) of the elements that label the component.
    ...
    * [v1.7.0](https://github.com/SAP/ui5-webcomponents/releases/tag/v1.7.0) of
  ...
  /** Determines which illustration breakpoint variant is used.
    ...
    * elements of the component are displayed differently on the different
    * breakpoints/illustration designs.
    *
    * **Note:** Available since
    ...
    * Default: "Auto"
    */
  lazy val design: HtmlAttr[IllustrationMessageDesign] =
    htmlAttr("design", StringUnionCodec[IllustrationMessageDesign])
  type IllustrationMessageDesign = "Auto" | "Base" | "Dot" | "Spot" | "Dialog" |
    "Scene"
  ...
  /** Defines the illustration name that will be displayed in the component.
    ...
    *
    * **Note:** To use the TNT illustrations, you need to set the `tnt` or `Tnt`
    ...
    *
    * **Note:** By default the `BeforeSearch` illustration is loaded. When using
    * an illustration type, other than the default, it should be loaded in
    * addition:
    *
    ...
    *
    * `import
    * "@ui5/webcomponents-fiori/dist/illustrations/tnt/SessionExpired.js";`
    *
  ...
  /** Defines the subtitle of the component.
    *
    * **Note:** Using this property, the default subtitle text of illustration
    * will be overwritten.
    *
    * **Note:** Using `subtitle` slot, the default of this property will be
    * overwritten.
    *
    * Default: undefined
    */
  ...
  /** Defines the title of the component.
    *
    * **Note:** Using this property, the default title text of illustration will
    * be overwritten.
    *
    * Default: undefined
    */
  ...
  /** Defines the subtitle of the component.
    *
    * **Note:** Using this slot, the default subtitle text of illustration and
    * the value of `subtitleText` property will be overwritten.
    *
    ...
    * attribute (`slot="subtitle"`). Since you can't change the DOM order of
  ...
  /** Defines the title of the component.
    *
    * **Note:** Using this slot, the default title text of illustration and the
    * value of `title` property will be overwritten.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot)
    * by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot)
    * attribute (`slot="title"`). Since you can't change the DOM order of slots
