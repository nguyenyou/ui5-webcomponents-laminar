...
object IllustratedMessage extends WebComponent("ui5-illustrated-message") {
  ...
  /** Determines which illustration breakpoint variant is used.
    ...
    * differently on the different breakpoints/illustration designs.
    *
  ...
  /** Defines the illustration name that will be displayed in the component.
    ...
    *
    * **Note:** By default the `BeforeSearch` illustration is loaded. When using an illustration type, other than the
    * default, it should be loaded in addition:
    *
  ...
  /** Defines the subtitle of the component.
    *
    * **Note:** Using this slot, the default subtitle text of illustration and the value of `subtitleText` property will
    * be overwritten.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="subtitle"`).
  ...
  /** Defines the title of the component.
    *
    * **Note:** Using this slot, the default title text of illustration and the value of `title` property will be
    * overwritten.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="title"`). Since
