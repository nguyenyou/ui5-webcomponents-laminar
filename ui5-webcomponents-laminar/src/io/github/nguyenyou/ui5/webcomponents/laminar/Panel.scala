...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distPanelMod.{
...
object Panel extends WebComponent("ui5-panel") {
  ...
  /** Sets the accessible ARIA role of the component. Depending on the usage,
    * you can change the role from the default `Form` to `Region` or
    * `Complementary`.
    *
    * Default: "Form"
    */
  ...
  /** Indicates whether the component is collapsed and only the header is
    * displayed.
    *
    * Default: false
    */
  ...
  /** Determines whether the component is in a fixed state that is not
    ...
    * Default: false
    */
  lazy val fixed: HtmlAttr[Boolean] =
    htmlAttr("fixed", BooleanAsAttrPresenceCodec)

  /** Defines the "aria-level" of component heading, set by the `headerText`.
    *
    * Default: "H2"
    */
  lazy val headerLevel: HtmlAttr[TitleLevel] =
    htmlAttr("header-level", StringUnionCodec[TitleLevel])
  type TitleLevel = "H1" | "H2" | "H3" | "H4" | "H5" | "H6"

  /** This property is used to set the header text of the component. The text is
  ...
  /** Indicates whether the transition between the expanded and the collapsed
    * state of the component is animated. By default the animation is enabled.
    *
    * Default: false
    */
  lazy val noAnimation: HtmlAttr[Boolean] =
    htmlAttr("no-animation", BooleanAsAttrPresenceCodec)

  /** Indicates whether the Panel header is sticky or not. If stickyHeader is
    * set to true, then whenever you scroll the content or the application, the
    * header of the panel will be always visible and a solid color will be used
    * for its design.
    *
    * Default: false
    */
  lazy val stickyHeader: HtmlAttr[Boolean] =
    htmlAttr("sticky-header", BooleanAsAttrPresenceCodec)
