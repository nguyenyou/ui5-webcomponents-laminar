...
object UserMenu extends WebComponent("ui5-user-menu") {
  ...
  /** Defines the ID or DOM Reference of the element at which the user menu is shown. When using this attribute in a
  ...
  /** Fired when the account is switched to a different one.
    ...
    * |     ✅      |    ❌    |
    */
  lazy val onChangeAccount: EventProp[Ui5CustomEvent[Ref] & EventDetail[UserMenuOtherAccountClickEventDetail]] =
  ...
  /** Fired when a menu item is selected.
    ...
    * |     ✅      |    ❌    |
    */
  lazy val onItemClick: EventProp[Ui5CustomEvent[Ref] & EventDetail[UserMenuItemClickEventDetail]] = new EventProp(
    "item-click"
  )
  ...
  /** Defines the user accounts.
    *
    * **Note:** If one item is used, it will be shown as the selected one. If more than one item is used, the first one
    * will be shown as selected unless there is an item with `selected` property set to `true`.
    *
    * __Note:__ The content of the prop will be rendered into a
    * [&lt;slot&gt;](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot) by assigning the respective
    * [slot](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/slot) attribute (`slot="accounts"`).
