...
object UserMenu extends WebComponent("ui5-user-menu") {
  ...
  type Ref = UserMenuComponent with dom.HTMLElement
  ...
  /** Defines the ID or DOM Reference of the element at which the user menu is
  ...
  /** Defines if the User Menu shows the Edit Accounts option.
    ...
    * Default: false
    */
  lazy val showEditAccounts: HtmlAttr[Boolean] =
    htmlAttr("show-edit-accounts", BooleanAsAttrPresenceCodec)
  ...
  /** Defines if the User menu shows edit button.
    ...
    * Default: false
    */
  lazy val showEditButton: HtmlAttr[Boolean] =
    htmlAttr("show-edit-button", BooleanAsAttrPresenceCodec)

  /** Defines if the User Menu shows the Manage Account option.
    *
    * Default: false
    */
  lazy val showManageAccount: HtmlAttr[Boolean] =
    htmlAttr("show-manage-account", BooleanAsAttrPresenceCodec)

  /** Defines if the User Menu shows the Other Accounts option.
    *
    * Default: false
    */
  lazy val showOtherAccounts: HtmlAttr[Boolean] =
    htmlAttr("show-other-accounts", BooleanAsAttrPresenceCodec)
  ...
  /** Fired when the account avatar is selected.
    ...
    * |     ❌      |    ❌    |
    */
  lazy val onAvatarClick: EventProp[Ui5CustomEvent[Ref]] = new EventProp(
    "avatar-click"
  )
  ...
  /** Fired when the account is switched to a different one.
    ...
    * |     ✅      |    ❌    |
    */
  lazy val onChangeAccount: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[UserMenuOtherAccountClickEventDetail]
  ] = new EventProp("change-account")
  ...
  /** Fired when the "Edit Accounts" button is selected.
    ...
    * |     ❌      |    ❌    |
    */
  lazy val onEditAccountsClick: EventProp[Ui5CustomEvent[Ref]] = new EventProp(
    "edit-accounts-click"
  )
  ...
  lazy val onItemClick: EventProp[
    Ui5CustomEvent[Ref] & EventDetail[UserMenuItemClickEventDetail]
  ...
  /** Fired when the "Manage Account" button is selected.
    ...
    * |     ❌      |    ❌    |
    */
  lazy val onManageAccountClick: EventProp[Ui5CustomEvent[Ref]] = new EventProp(
  ...
  /** Fired when the "Sign Out" button is selected.
    ...
    * |     ✅      |    ❌    |
    */
  lazy val onSignOutClick: EventProp[Ui5CustomEvent[Ref]] = new EventProp(
    "sign-out-click"
  )
  ...
  /** Defines the user accounts.
    *
    * **Note:** If one item is used, it will be shown as the selected one. If
    * more than one item is used, the first one will be shown as selected unless
    ...
    * attribute (`slot="accounts"`). Since you can't change the DOM order of
