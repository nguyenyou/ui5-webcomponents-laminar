...
import io.github.nguyenyou.ui5.webcomponents.ui5Webcomponents.distToolbarSelectOptionMod.{
  ToolbarSelectOption as ToolbarSelectOptionComponent
}
...
object ToolbarSelectOption extends WebComponent("ui5-toolbar-select-option") {
  ...
  type Ref = ToolbarSelectOptionComponent with dom.HTMLElement
